#!/usr/bin/env node
/**
 * CI lint that fails if a `packages/ovo/test/fixtures/` tree appears.
 ...
 * `packages/ovo/src/internal/testing/scenario-apps/`. Contributors who
...
const FIXTURES_ROOT = resolve(
  fileURLToPath(new URL("../packages/ovo/test/fixtures", import.meta.url)),
);
...
async function main() {
  try {
    ...
    process.stdout.write("[ovo:guard] ok — packages/ovo/test/fixtures/ does not exist.\n");
    return;
  }

  process.stderr.write(
    [
      "[ovo:guard] FAIL: packages/ovo/test/fixtures/ exists.",
      "",
      "Committed fixture trees are not allowed in this repo.",
      "Add new scenario-tier app content as a `ScenarioAppDescriptor` under",
      "`packages/ovo/src/internal/testing/scenario-apps/` and materialize it with",
