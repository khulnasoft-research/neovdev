...
// neodev-agent-worker "command" backend. dispatch.py / cancel.py transform the task
// payload and delegate execution to an HTTP REST endpoint; dispatch-neodev-local.py
// launches a real neodev agent run on the host for local end-to-end testing. The
