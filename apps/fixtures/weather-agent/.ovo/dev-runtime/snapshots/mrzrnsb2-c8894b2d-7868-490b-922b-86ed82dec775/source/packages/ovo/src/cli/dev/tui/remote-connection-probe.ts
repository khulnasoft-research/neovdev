...
/**
 * Confirms the target is a live ovo deployment via the always-public health
 ...
 * deployment whose `/ovo/v1/info` is absent.
 */
...
export async function probeRemoteInfo(input: {
  ...
  if (
    ...
    // the target ready once the public health route confirms a live Ovo server.
