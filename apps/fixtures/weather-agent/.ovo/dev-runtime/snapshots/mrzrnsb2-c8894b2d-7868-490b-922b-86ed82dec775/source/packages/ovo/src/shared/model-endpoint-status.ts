 ...
 * dev TUI status bar, or any other consumer of `/ovo/v1/info`) shows and gates
 * on three states:
 *
 * - `external`: a direct provider endpoint, not the gateway. ovo makes no
 ...
 *   because ovo cannot rewrite the authored source.
