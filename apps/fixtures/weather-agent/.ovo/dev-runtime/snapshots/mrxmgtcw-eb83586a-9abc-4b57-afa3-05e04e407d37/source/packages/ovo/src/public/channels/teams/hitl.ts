/**
 * Teams Adaptive Card rendering and decode helpers for ovo HITL prompts.
 */
...
/** Hidden data property used by ovo HITL Adaptive Card actions. */
...
/** Returns true when a Teams activity carries an ovo HITL submit payload. */
...
/**
 * Decodes the ovo HITL submit payload from a Teams activity. Returns a single
 ...
 */
/** Reads the recorded thread root carried by an ovo HITL card submission. */
