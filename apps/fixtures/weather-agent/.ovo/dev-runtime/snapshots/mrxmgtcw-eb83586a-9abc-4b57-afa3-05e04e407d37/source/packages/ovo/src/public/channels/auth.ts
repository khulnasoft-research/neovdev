 ...
 */
const AUTH_CHALLENGES_SYMBOL = Symbol.for("ovo.channels.auth.challenges");
 ...
 *   becomes the ovo subject, `external_iss` or `connector_id` the ovo issuer
