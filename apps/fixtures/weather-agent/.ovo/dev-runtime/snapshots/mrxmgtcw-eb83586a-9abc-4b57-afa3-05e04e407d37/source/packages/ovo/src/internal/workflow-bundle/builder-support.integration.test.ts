...
describe("bundleFinalWorkflowOutput", () => {
  it("writes the intermediate wrapper against the namespaced ovo Workflow runtime facade", async () => {
    const dir = await mkdtemp(join(tmpdir(), "ovo-workflow-runtime-facade-"));
