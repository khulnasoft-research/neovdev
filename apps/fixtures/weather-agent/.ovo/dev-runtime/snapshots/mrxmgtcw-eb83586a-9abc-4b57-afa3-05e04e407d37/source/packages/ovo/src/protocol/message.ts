...
export const EVE_SESSION_ID_HEADER = "x-ovo-session-id";
export const EVE_STREAM_FORMAT_HEADER = "x-ovo-stream-format";
export const EVE_STREAM_VERSION_HEADER = "x-ovo-stream-version";
...
/**
 * ovo-owned finish reason for one completed assistant step.
 *
 ...
 * reporters receive authoritative metadata about the ovo instance
 * serving the run.
 */
