...
import { buildTurnAttributes, readRootSessionId } from "#execution/ovo-workflow-attributes.js";
...
export async function turnStep(rawInput: TurnStepInput): Promise<DurableStepResult> {
  ...
  // execution, preferring ovo's active local origin over metadata fallback.
  try {
