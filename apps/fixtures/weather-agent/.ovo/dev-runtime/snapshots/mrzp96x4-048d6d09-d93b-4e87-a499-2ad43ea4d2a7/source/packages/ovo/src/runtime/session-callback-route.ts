...
export const HTTP_SESSION_CALLBACK_CHANNEL_NAME_PREFIX = "ovo/v1/callback";
...
function buildCallbackChannelDefinition(method: ChannelMethod): ResolvedChannelDefinition {
  ...
  return {
    ...
    sourceId: `ovo:framework:session-callback-${method.toLowerCase()}`,
    sourceKind: "module",
  };
}
...
/**
 * TokenUsage arrives from a remote callee that may run a different ovo version,
