 ...
 * ovo stores compact callback ids in durable channel state and remaps
 * them back to full input responses inside the channel deliver hook.
 */

import type { InputRequest, InputResponse } from "#runtime/input/types.js";

/** Prefix used in Telegram callback_data values generated by ovo. */
export const TELEGRAM_HITL_CALLBACK_PREFIX = "ovo:";
...
/** Remaps compact Telegram callback/reply ids into real ovo input responses. */
