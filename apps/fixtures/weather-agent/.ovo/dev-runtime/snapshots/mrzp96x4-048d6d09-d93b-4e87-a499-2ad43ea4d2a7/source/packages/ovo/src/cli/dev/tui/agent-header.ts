 ...
 * first prompt: one `ovo <agent name>` brand line, a discovery-diagnostics
 ...
 * slash commands, so callers only attach a tip to local `ovo dev` sessions.
 */
