 ...
 *
 * ```
 * ovo-sandbox:?path=<urlencoded-resolved-path>&size=<bytes>&type=<mediaType>
 * ```
 */
 ...
 */
export const SANDBOX_URL_SCHEME = "ovo-sandbox:";
 ...
 *
 * Accepts `URL` instances with the `ovo-sandbox:` scheme. Strings are
