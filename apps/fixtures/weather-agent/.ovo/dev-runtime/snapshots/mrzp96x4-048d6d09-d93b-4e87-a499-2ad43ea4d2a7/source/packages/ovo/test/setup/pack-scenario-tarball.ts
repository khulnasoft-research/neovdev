...
const EVE_PACKAGE_NAME_TARBALL_PREFIX = "ovo";
const SCENARIO_CACHE_ROOT = join(tmpdir(), "ovo-scenario-cache");
const SHARED_TARBALLS_ROOT = join(SCENARIO_CACHE_ROOT, "shared-tarballs");

/**
 * Vitest `globalSetup` that packs the ovo package exactly once before any
