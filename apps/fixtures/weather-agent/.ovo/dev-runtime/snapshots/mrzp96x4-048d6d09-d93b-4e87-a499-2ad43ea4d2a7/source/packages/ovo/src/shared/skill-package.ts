...
/**
 * Normalizes one named skill package into the concrete files ovo writes to
 ...
 *
 * For a `rootPath` of `.ovo/compile/workspace-resources/__root__` and a skill
...
function assertSafeSkillPackageFilePath(relativePath: string): void {
  if (relativePath === "SKILL.md") {
    throw new Error('Skill package files must not include "SKILL.md"; ovo generates it.');
  }
