...
describe("fireSessionCallbackStep", () => {
  ...
  it("posts the completed callback from serialized context", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith("https://caller.example.com/ovo/v1/callback/tok123", {
      body: JSON.stringify({
        callId: "call-1",
  ...
  it.each([
    ...
    [
      "wrong callback route",
      {
        ...
        subagentName: "research",
        token: "tok123",
        url: "https://caller.example.com/ovo/v1/session/tok123",
      },
    ],
    [
      "url token mismatch",
    ...
    [
      "malformed encoded token",
      {
        ...
        subagentName: "research",
        token: "tok123",
        url: "https://caller.example.com/ovo/v1/callback/%E0%A4%A",
      },
    ],
    [
      "private callback host",
      {
        ...
        subagentName: "research",
        token: "tok123",
        url: "http://169.254.169.254/ovo/v1/callback/tok123",
      },
    ],
    [
      "extra field",
