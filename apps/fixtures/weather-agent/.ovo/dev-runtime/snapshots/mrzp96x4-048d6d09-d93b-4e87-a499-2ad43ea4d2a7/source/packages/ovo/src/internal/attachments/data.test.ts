...
describe("fileDataToBytes", () => {
  ...
  it("returns null for ovo-attachment: URLs (caller owns the resolver dispatch)", async () => {
...
describe("getKnownByteLength", () => {
  ...
  it("returns ref.size for ovo-attachment: URLs when the adapter populated it", () => {
  ...
  it("returns null for ovo-attachment: URLs without a size in the payload", () => {
