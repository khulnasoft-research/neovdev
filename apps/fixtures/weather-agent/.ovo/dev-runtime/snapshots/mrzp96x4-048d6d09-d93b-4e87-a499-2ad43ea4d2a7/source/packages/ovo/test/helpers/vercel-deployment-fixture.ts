...
/**
 * One deployed test app prepared from a fixture copy and an ovo tarball.
 */
...
export interface CreateTarballVercelDeploymentFixtureInput {
  ...
  /** Wait for the deployed ovo health route after the Vercel build succeeds. */
  readonly waitForHealth?: boolean;
}

/**
 * Materializes the descriptor into a fresh temporary directory, wires the
 * app to depend on the locally packed ovo tarball, deploys it to Vercel,
