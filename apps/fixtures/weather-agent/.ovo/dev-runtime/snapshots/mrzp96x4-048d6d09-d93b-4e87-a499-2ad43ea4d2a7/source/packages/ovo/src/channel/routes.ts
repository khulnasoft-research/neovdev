...
export interface SendPayload {
  ...
  /**
   * Context strings contributed by the channel. ovo appends each entry
   ...
   * {@link BaseSendOptions.mode}: ovo enforces the schema in either mode; mode
 ...
 * that connection. The hooks are ovo-owned structural types so channel authors
 * can use CrossWS-compatible helpers without ovo exposing CrossWS directly.
 */
