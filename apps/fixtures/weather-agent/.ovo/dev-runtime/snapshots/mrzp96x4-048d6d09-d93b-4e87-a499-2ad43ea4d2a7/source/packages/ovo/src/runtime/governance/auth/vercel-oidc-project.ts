...
const VERCEL_OIDC_PROJECT_RESOLVERS = Symbol.for("ovo.vercel-oidc-project-resolvers");
 ...
 * the binding visible to both Nitro-inlined and disk-imported ovo modules.
 */
