...
import { ClientSession, MessageResponse, type HandleMessageStreamEvent } from "ovo/client";
 ...
 * runner + renderer without spinning up a real ovo server. The other
...
const firstTurn: HandleMessageStreamEvent[] = [
  ...
  { type: "step.started", data: { sequence: next(), stepIndex, turnId } },
  {
    ...
    data: {
      ...
      stepIndex,
      turnId,
      webhookUrl: "http://localhost:3000/ovo/v1/connections/stub-mcp/callback/xyz",
    },
  },
  {
    type: "step.completed",
...
const secondTurn: HandleMessageStreamEvent[] = [
  ...
  { type: "step.started", data: { sequence: next(), stepIndex, turnId: secondTurnId } },
  {
    ...
    data: {
      ...
      stepIndex,
      turnId: secondTurnId,
      webhookUrl: "http://localhost:3000/ovo/v1/connections/other-mcp/callback/xyz",
    },
  },
  {
    type: "step.completed",
