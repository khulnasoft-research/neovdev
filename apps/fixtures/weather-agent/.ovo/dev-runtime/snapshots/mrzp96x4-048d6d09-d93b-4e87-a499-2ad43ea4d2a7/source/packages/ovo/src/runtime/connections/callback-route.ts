 ...
 * keeps the public surface namespaced under ovo and lets the framework
 ...
 */
export const HTTP_CONNECTION_CALLBACK_CHANNEL_NAME_PREFIX = "ovo/v1/connections/callback";
...
function buildCallbackChannelDefinition(method: ChannelMethod): ResolvedChannelDefinition {
  ...
  return {
    ...
    sourceId: `ovo:framework:connection-callback-${method.toLowerCase()}`,
    sourceKind: "module",
  };
}
