...
const DEFAULT_PROVIDER = "ovo-mock";
...
export interface MockModelToolCall {
  ...
  /** Stable call id. ovo derives one when omitted. */
  readonly id?: string;
}

/** Optional token counts reported by a mock response. */
export interface MockModelUsage {
  /** Prompt tokens. ovo estimates this value when omitted. */
  readonly inputTokens?: number;
  /** Generated tokens. ovo estimates this value when omitted. */
...
export interface MockModelResponse {
  ...
  /** Token counts to report instead of ovo's deterministic estimates. */
...
export interface MockModelOptions {
  ...
  /** Provider id exposed to the agent runtime. Defaults to `"ovo-mock"`. */
...
/**
 * Creates a deterministic local language model for an ovo eval fixture.
 *
