 ...
 *
 * Discord components carry a `custom_id` with a 100-character cap. ovo
...
/**
 * Decodes an ovo HITL component interaction into input responses. Empty array
 * if the custom id is not an ovo HITL id; otherwise one response from the
...
/**
 * Decodes an ovo freeform modal submission into a single text input response.
