...
export const EXTENSION_COMPATIBILITY_MANIFEST_KIND = "ovo-extension";
...
const EXTENSION_CAPABILITY_CONTRACTS = {
  extension: { current: 2, supported: [1, 2], dropped: {} },
  ...
  config: { current: 2, supported: [1, 2], dropped: {} },
...
/**
 * Capability contract versions this ovo release can consume.
 */
...
/** Compatibility-only metadata emitted by `ovo extension build`. */
...
/** One requirement the consuming ovo cannot satisfy. */
