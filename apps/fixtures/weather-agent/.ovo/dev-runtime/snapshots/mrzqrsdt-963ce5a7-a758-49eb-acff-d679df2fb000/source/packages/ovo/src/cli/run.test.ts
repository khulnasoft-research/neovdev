...
describe("ovo init compatibility flags", () => {
...
describe("ovo CLI malformed argument handling", () => {
...
describe("ovo eval --url protocol", () => {
...
describe("ovo dev boot progress", () => {
...
describe("ovo dev local server ownership", () => {
...
describe("ovo build output ownership", () => {
  ...
  it("resolves the internal service output directory from the build working directory", async () => {
    ...
    const configuredDirectory = ".ovo/vercel-services/ovo/.vercel/output";
  ...
  it("rejects an incomplete internal Vercel service output contract", async () => {
    vi.stubEnv("EVE_INTERNAL_BUILD_OUTPUT_DIRECTORY", ".ovo/vercel-services/ovo/.vercel/output");
