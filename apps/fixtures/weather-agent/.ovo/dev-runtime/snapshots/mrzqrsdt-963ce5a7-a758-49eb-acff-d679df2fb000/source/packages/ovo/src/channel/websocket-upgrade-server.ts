 ...
 * upgrade target inside an ovo `WS()` route.
 *
 * Prefer normal `WS()` lifecycle hooks for ovo-owned websocket behavior. Use
 ...
 * not listening on a port; ovo forwards only the matched route's raw Node
 * upgrade into it.
 */
