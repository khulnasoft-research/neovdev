...
/**
 * Builds an unguessable route path for ovo's Vercel cron handler.
 *
 ...
 * incoming requests.
 *
 * ovo sidesteps the manual env var by giving each build a unique random
...
/**
 * Applies ovo's unguessable cron handler route to a Nitro instance built
