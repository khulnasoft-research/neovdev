...
/** Parsed `ovo dev` options that control terminal-UI behavior. */
...
/** Whether `ovo dev` launches the terminal UI or keeps only the server running. */
...
/** Builds terminal-UI display options with the defaults used by `ovo dev`. */
