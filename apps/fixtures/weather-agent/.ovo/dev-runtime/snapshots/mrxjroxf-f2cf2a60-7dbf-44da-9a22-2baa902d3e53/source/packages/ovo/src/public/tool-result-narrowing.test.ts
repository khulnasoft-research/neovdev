...
describe("toolResultFrom", () => {
  ...
  it("uses source-derived keys to distinguish tools with the same description", () => {
    ...
    expect(warn).toHaveBeenCalledWith(
      expect.stringContaining(
        'ovo could not assign a unique toolResultFrom identity for "tool:Run the shared action."',
      ),
    );
    expect(warn).toHaveBeenCalledWith(
      expect.stringContaining(
  ...
  it("uses source-derived keys to distinguish connections with the same URL", () => {
    ...
    expect(warn).toHaveBeenCalledWith(
      expect.stringContaining(
        'ovo could not assign a unique toolResultFrom identity for "connection:https://mcp.example.test"',
      ),
    );
    expect(warn).toHaveBeenCalledWith(
      expect.stringContaining(
