...
describe("resolveAuthorizationCallbackUrl", () => {
  it.each([
    [
      "http://127.0.0.1:2000/ovo/v1/connections/notion/callback/wrun_123%3Aauth",
      "http://localhost:2000/ovo/v1/connections/notion/callback/wrun_123%3Aauth",
    ],
    [
      "http://[::1]:2000/ovo/v1/connections/notion/callback/wrun_123%3Aauth",
      "http://localhost:2000/ovo/v1/connections/notion/callback/wrun_123%3Aauth",
    ],
