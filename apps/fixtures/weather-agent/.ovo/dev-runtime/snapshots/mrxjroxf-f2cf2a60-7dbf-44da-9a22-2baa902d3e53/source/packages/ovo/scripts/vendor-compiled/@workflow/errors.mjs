 ...
 * keeps every signature in `@workflow/errors` valid for ovo and any
 ...
 * @workflow/errors version so the error class hierarchy ovo exposes
 ...
 * `./error-codes.js`). The two unused-by-ovo entry-point declarations
 * (`ansi.d.ts`, `internal-chalk.d.ts`) are intentionally not copied —
 * they describe sub-paths ovo never imports.
 */
export default {
