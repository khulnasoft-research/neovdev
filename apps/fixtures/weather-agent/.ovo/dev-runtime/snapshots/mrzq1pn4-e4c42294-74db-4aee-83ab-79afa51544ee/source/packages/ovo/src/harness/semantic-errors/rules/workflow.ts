...
export const WORKFLOW_RULES: readonly SemanticErrorRule[] = [
  {
    ...
    message:
      "The local workflow store (`.ovo/.workflow-data`) was created by an incompatible version.",
  ...
  },
  {
    ...
    message: "The local workflow store (`.ovo/.workflow-data`) could not be created or accessed.",
  ...
  },
  {
    ...
    hint: "Start a fresh session (`/new` in `ovo dev`).",
  },
  {
    ...
    hint: "Remove `.ovo/.workflow-data` to reset local sessions, then retry.",
  },
  {
