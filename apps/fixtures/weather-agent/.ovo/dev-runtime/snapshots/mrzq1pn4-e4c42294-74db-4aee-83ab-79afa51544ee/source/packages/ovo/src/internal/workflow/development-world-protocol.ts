...
export const DEVELOPMENT_WORKFLOW_WORLD_ROUTE = "/ovo/v1/dev/internal/workflow-world";
...
export const DEVELOPMENT_WORKFLOW_TRANSPORT_HEADER = "x-ovo-dev-workflow-transport";
export const DEVELOPMENT_WORKFLOW_DELIVERY_HEADER = "x-ovo-dev-workflow-delivery";
