...
describe("createNitroBundlerConfig", () => {
  it("suppresses vendored dependency warnings without hiding actionable logs", () => {
    ...
    onLog(
      ...
      {
        loc: {
          file: "/repo/packages/ovo/.generated/compiled/gray-matter/index.js",
        },
    ...
    onLog(
      "warn",
      {
        id: "/repo/packages/ovo/dist/src/compiled/gray-matter/index.js",
    ...
    onLog(
      "warn",
      {
        id: "/repo/packages/ovo/src/internal/nitro/host/create-application-nitro.ts",
        message: "ovo build warning",
      },
      defaultHandler,
    );
    onLog(
    ...
    expect(defaultHandler).toHaveBeenNthCalledWith(
      1,
      "warn",
      expect.objectContaining({ message: "ovo build warning" }),
    );
    expect(defaultHandler).toHaveBeenNthCalledWith(
      2,
      "error",
