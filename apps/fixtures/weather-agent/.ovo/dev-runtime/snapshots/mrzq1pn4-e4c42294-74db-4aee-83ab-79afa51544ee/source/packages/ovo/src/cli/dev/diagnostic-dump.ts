...
/**
 * Environment facts captured once per `ovo dev` process, written into the
 ...
 * composable with the log by plain concatenation (`ovo logs --dump`).
 */
 ...
 * (`.ovo/.workflow-data`). Returns `undefined` when the directory does not
 * exist yet.
 */
