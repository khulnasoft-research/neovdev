...
describe("workspace glob helpers", () => {
  it.each([
    ...
    ["packages/*/fixtures", "packages/ovo/fixtures", true],
    ["packages/*/fixtures", "packages/ovo/test/fixtures", false],
  ...
  it("derives the sibling package pattern for a nested project path", () => {
    ...
    expect(workspacePatternForProject("/repo", "/repo/apps/ovo/my-agent")).toBe("apps/ovo/*");
