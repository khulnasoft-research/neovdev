...
export const AuthKey = new ContextKey<SessionAuthContext | null>("ovo.auth");
export const InitiatorAuthKey = new ContextKey<SessionAuthContext | null>("ovo.initiatorAuth");
export const SessionIdKey = new ContextKey<string>("ovo.sessionId");
export const ContinuationTokenKey = new ContextKey<string>("ovo.continuationToken");
export const ChannelRequestIdKey = new ContextKey<string>("ovo.channelRequestId");
export const ChannelInstrumentationKey = new ContextKey<ChannelInstrumentationProjection>(
  "ovo.channelInstrumentation",
);
export const ModeKey = new ContextKey<RunMode>("ovo.mode");
export const ParentSessionKey = new ContextKey<SessionParent>("ovo.parentSession");
export const SubagentDepthKey = new ContextKey<number>("ovo.subagentDepth");
 ...
 */
export const CapabilitiesKey = new ContextKey<SessionCapabilities>("ovo.capabilities");

/**
 * Optional framework-owned terminal callback metadata for this session.
 */
export const SessionCallbackKey = new ContextKey<SessionCallback>("ovo.sessionCallback");

// ---------------------------------------------------------------------------
// Derived keys — reconstructed by providers each step, never serialized.
// ---------------------------------------------------------------------------

export const SessionKey = new ContextKey<Session>("ovo.session");
export const SandboxKey = new ContextKey<SandboxAccess>("ovo.sandbox");
...
export const SessionDynamicModelReferenceKey = new ContextKey<RuntimeModelReference | null>(
  "ovo.sessionDynamicModelReference",
);
...
export const LiveStepDynamicModelSelectionKey = new ContextKey<LiveDynamicModelSelection | null>(
  "ovo.liveStepDynamicModelSelection",
);
...
export const SessionDynamicToolMetadataKey = new ContextKey<readonly DurableDynamicToolMetadata[]>(
  "ovo.sessionDynamicToolMetadata",
);
...
>("ovo.sessionDynamicInstructions");
