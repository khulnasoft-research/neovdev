 ...
 *
 * ```
 * ovo-attachment:?v=1&p=<base64url-encoded JSON of { params, size? }>
 * ```
 */
 ...
 */
export const ATTACHMENT_REF_SCHEME = "ovo-attachment:";
 ...
 *
 * Accepts `URL` instances with the `ovo-attachment:` scheme. Strings
