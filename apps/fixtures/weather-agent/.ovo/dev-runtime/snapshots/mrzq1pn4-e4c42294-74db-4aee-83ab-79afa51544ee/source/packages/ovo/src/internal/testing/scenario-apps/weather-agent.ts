...
const WEATHER_AGENT_SOURCE = `import { defineAgent } from "ovo";
...
const WEATHER_TOOL_SOURCE = `import { defineTool } from "ovo/tools";
import { z } from "zod";
...
const WEATHER_CHANNEL_WEBHOOK_SOURCE = `import { defineChannel, POST } from "ovo/channels";
...
const WEATHER_EVAL_CONFIG_SOURCE = `import { defineEvalConfig } from "ovo/evals";
...
const WEATHER_EVAL_SOURCE = `import { defineEval } from "ovo/evals";
import { loadYaml } from "ovo/evals/loaders";
 ...
 * `ovo dev` HMR, port-retry, CLI, and public-API portability tests.
 *
