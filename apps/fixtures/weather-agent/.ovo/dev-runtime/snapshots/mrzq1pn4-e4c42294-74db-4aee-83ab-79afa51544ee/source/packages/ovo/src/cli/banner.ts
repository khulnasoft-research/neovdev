...
export const EVE_WORDMARK = "ovo";

/**
 * The boot banner shared by every CLI command that announces itself: the ovo
...
/**
 * The unstyled wordmark-and-version tag (`☰ovo  v0.24.5`) — the boot banner's
