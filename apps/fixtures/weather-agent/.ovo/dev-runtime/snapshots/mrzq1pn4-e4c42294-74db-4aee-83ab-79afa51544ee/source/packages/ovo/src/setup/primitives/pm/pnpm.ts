...
// ovo@0.6.0-beta.13 through 0.7.0 imported `oxc-parser` at runtime while
...
export const PNPM_WORKSPACE_CONTENT = [
  ...
  "allowBuilds:",
  "  sharp: false",
  "# Compatibility for ovo releases with an incomplete runtime manifest.",
  "packageExtensions:",
...
function parsePnpmWorkspacePackagePatterns(source: string): string[] | undefined {
  ...
  // This deliberately supports the common workspace shapes ovo needs to edit:
