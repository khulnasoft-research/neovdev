/**
 * Stable framework-owned route prefix reserved for ovo's runtime transport
 * surfaces.
 */
export const EVE_ROUTE_PREFIX = "/ovo/v1";
 ...
 * the current agent. The ovo channel registers and authenticates this route
 ...
 * via a 3xx redirect from the user's browser with no ovo credentials
