  ...
  it("emits ESM-safe file URLs for Windows absolute imports", () => {
    const source = createCompiledModuleMapSource({
      ...
      manifest: createManifestWithTool(
        "G:\\projects\\ovo\\apps\\fixtures\\kitchen-sink-fixture\\agent",
      ),
      moduleMapPath:
        "G:\\projects\\ovo\\apps\\fixtures\\kitchen-sink-fixture\\.ovo\\compile\\module-map.mjs",
    });

    expect(source).toContain(
      'import * as module_0 from "file:///G:/projects/ovo/apps/fixtures/kitchen-sink-fixture/agent/tools/echo.ts";',
    );
    expect(source).not.toContain(
      '"G:/projects/ovo/apps/fixtures/kitchen-sink-fixture/agent/tools/echo.ts"',
    );
