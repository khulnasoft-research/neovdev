...
/**
 * Lineage metadata for the ovo parent execution that delegated this session.
 *
...
/**
 * Runtime capabilities granted to one ovo session.
 *
...
export interface RunInput {
   ...
   * runtime derives `$ovo.title` from {@link input.message}.
   */
