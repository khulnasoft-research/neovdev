...
const mocks = vi.hoisted(() => {
  const activeGeneration = {
    appRoot: "/app/.ovo/dev-runtime/snapshots/active/runtime",
    kind: "disk" as const,
    moduleMapLoaderPath: "/app/node_modules/ovo/module-map-loader.js",
    sandboxAppRoot: "/app",
  };
  return {
    activeGeneration,
    createScheduleRegistrations: vi.fn(() => [
      {
        ...
        taskName: "ovo.schedule.heartbeat",
      },
    ]),
...
const ARTIFACTS_CONFIG = {
  appRoot: "/app",
  devRuntimeArtifactsPointerPath: "/app/.ovo/dev-runtime/current.json",
  kind: "development",
  moduleMapLoaderPath: "/app/node_modules/ovo/module-map-loader.js",
} as const;
