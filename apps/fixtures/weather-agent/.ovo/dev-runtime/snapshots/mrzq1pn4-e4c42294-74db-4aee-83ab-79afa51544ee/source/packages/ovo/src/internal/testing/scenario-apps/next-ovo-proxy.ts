...
/**
 * A Next.js host with routing middleware and a generated ovo service.
 */
...
`,
      ...
      "next.config.mjs": `import { withEve } from "ovo/next";
...
`,
  ...
  return <main>ovo middleware deployment</main>;
}
`,
