 ...
 */
const DISCOVERY_DIAGNOSTICS_ARTIFACT_KIND = "ovo-discovery-diagnostics";
 ...
 */
export const COMPILE_METADATA_KIND = "ovo-compile-metadata";
...
/**
 * Structured paths for compiler-owned artifacts under `.ovo/`.
 */
...
export function resolveCompilerArtifactPaths(appRoot: string): CompilerArtifactPaths {
  return resolveCompilerArtifactPathsAt(appRoot, join(resolve(appRoot), ".ovo"));
}
