...
export interface TeamsApiOptions {
   ...
   * `https://login.microsoftonline.com`. ovo ignores it when
...
/** Bot Framework/Teams attachment shape supported by ovo-owned APIs. */
...
/** JSON body supported by Teams message endpoints used by ovo. */
