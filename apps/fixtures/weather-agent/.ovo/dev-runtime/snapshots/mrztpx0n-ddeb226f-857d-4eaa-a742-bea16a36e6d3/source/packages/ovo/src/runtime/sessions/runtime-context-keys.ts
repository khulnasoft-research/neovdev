...
export const ChannelKey = new ContextKey<ChannelAdapter>("ovo.channel", {
  codec: {
    ...
    deserialize(data, ctx): ChannelAdapter {
      ...
      if (bundle === undefined) {
        throw new Error(
          'Cannot deserialize "ovo.channel" before "ovo.bundle". The runtime bundle must be present in context.',
        );
      }
...
export const BundleKey = new ContextKey<CompiledBundle>("ovo.bundle", {
  codec: {
