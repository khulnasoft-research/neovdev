 ...
 * dev server. Used by the dev-only `POST /ovo/v1/dev/schedules/:scheduleId`
 ...
 * them via the existing `/ovo/v1/session/:sessionId/stream` route as soon
 * as this resolves.
 *
 ...
 * resolve relative to the app instead of the installed ovo package.
 */
