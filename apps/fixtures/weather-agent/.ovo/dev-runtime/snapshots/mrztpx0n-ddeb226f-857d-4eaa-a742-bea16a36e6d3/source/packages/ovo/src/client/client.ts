...
/**
 * HTTP client for talking to a deployed ovo agent.
 *
...
export class Client {
  ...
  /**
   * Checks the health of the ovo agent server.
   *
  ...
  /**
   * Fetches the agent inspection payload from `GET /ovo/v1/info`.
   *
  ...
  /**
   * Performs an authenticated fetch against a path on this ovo target.
   *
