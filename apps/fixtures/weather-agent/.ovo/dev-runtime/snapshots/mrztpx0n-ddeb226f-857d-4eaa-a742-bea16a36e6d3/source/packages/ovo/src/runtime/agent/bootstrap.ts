 ...
 * runtime path.
 */
export const BOOTSTRAP_RUNTIME_MODEL_ID = "ovo-bootstrap-model";
...
export const BOOTSTRAP_RUNTIME_SYSTEM_PROMPT =
  "You are the ovo bootstrap agent. Be concise, stay grounded in the current conversation, and do not assume tools are available unless the runtime provides them.";
