...
export const DEVELOPMENT_CLIENT_ADDRESS_HEADER = "x-ovo-dev-client-address";
export const DEVELOPMENT_CLIENT_ADDRESS_SIGNATURE_HEADER = "x-ovo-dev-client-address-signature";
