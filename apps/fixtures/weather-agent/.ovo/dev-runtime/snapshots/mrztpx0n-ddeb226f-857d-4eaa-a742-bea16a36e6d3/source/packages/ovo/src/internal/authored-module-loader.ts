 ...
 * "Expected … to match the public ovo shape" failures during
 * compilation.
 *
...
function createVirtualGenerationModuleMapPlugin(input: {
  ...
  return {
    name: "ovo-generation-module-map",
    resolveId(id: string) {
...
function createAuthoredDirectiveGuardPlugin(): Record<string, unknown> {
  return {
    name: "ovo-authored-directive-guard",
...
function createAuthoredRelativeExtensionResolverPlugin(input: {
  ...
  return {
    name: "ovo-authored-relative-extension-resolver",
