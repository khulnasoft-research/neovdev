...
const EVE_CACHE_METADATA_FILE = "ovo-cache.json";

/**
 * Clears one ovo-owned cache directory when its recorded ovo version is missing
...
/**
 * Writes the current installed ovo version into one ovo-owned cache directory.
 */
