...
export interface ResolveTargetOptions {
  ...
  inPlace?: boolean;
  /**
   * Treat an existing `./<name>` that is already an ovo project as resumable
 ...
 * existing ovo project directory instead of refusing it (composed via
...
export function resolveTarget(
   ...
   * opted into resuming an existing ovo project there (headless re-runs). Used
