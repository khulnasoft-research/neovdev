/**
 * Optional sandbox engine packages ovo's runtime references through
 ...
 * example ovo's own workspace devDependencies) would pull them into
...
export function createOptionalEngineDependencyPlugin(
  ...
  return {
    name: "ovo-optional-engine-dependency-external",
    resolveId(source) {
