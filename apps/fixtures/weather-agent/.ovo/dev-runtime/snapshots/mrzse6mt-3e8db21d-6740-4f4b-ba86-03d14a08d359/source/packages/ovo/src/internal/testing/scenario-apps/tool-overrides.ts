...
`,
    "agent/tools/agent.ts": `import { disableTool } from "ovo/tools";

// Removes the root-only recursive self-copy tool.
export default disableTool();
`,
    "agent/tools/bash.ts": `import { defineTool } from "ovo/tools";
import { always } from "ovo/tools/approval";
import { bash } from "ovo/tools/defaults";
...
`,
    "agent/tools/todo.ts": `import { defineState } from "ovo/context";
...
`,
    "agent/tools/web_fetch.ts": `import { disableTool } from "ovo/tools";
...
export default disableTool();
`,
    "agent/tools/web_search.ts": `import { disableTool } from "ovo/tools";
