...
/**
 * Client-side reducer event emitted before ovo confirms a submitted user
 ...
 * ovo confirms it with a `message.received` stream event.
 */
...
/**
 * Event consumed by ovo agent reducers.
 *
 * Server events are authoritative ovo stream events. They include text,
...
/**
 * Projects ovo stream events into accumulated consumer data.
 */
