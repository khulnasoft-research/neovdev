...
const EVE_CHANNEL_VIRTUAL_ID_PREFIX = "#nitro/virtual/ovo-channel/";
...
/**
 * One Nitro route registration for an ovo channel.
 */
...
/**
 * Registers virtual Nitro handlers for the provided ovo channel routes.
 */
