...
describe("schedule registration", () => {
  it("creates stable Nitro registration inputs from resolved schedules", () => {
    expect(
      ...
      {
        cron: "0 0 * * 0",
        description: 'Run ovo schedule "cleanup" from "schedules/cleanup.md".',
        logicalPath: "schedules/cleanup.md",
        scheduleId: "cleanup",
        sourceId: "schedules/cleanup.md",
        taskName: "ovo.schedule.c2NoZWR1bGVzL2NsZWFudXAubWQ",
      },
      {
        cron: "0 8 * * *",
        ...
        sourceId: "schedules/daily-digest.mjs",
        taskName: "ovo.schedule.c2NoZWR1bGVzL2RhaWx5LWRpZ2VzdC5tanM",
      },
    ]);
  });
