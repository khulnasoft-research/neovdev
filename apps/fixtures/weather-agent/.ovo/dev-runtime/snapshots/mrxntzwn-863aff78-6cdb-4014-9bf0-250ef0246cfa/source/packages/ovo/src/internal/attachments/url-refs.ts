 ...
 * `ovo-url:https://...` strings. After the queue, the staging pipeline
...
/**
 * Framework-internal `FilePart.data` ref schemes (`ovo-url:`, `ovo-sandbox:`,
 * `ovo-attachment:`). ovo produces these during its own serialization and
