...
export const PendingAuthorizationResultKey = new ContextKey<readonly NamedAuthorizationResult[]>(
  "ovo.pendingAuthorizationResult",
);
 ...
 * metadata.
 */
export const CallbackBaseUrlKey = new ContextKey<string>("ovo.callbackBaseUrl");

// ---------------------------------------------------------------------------
// Session state persistence (internal — used by framework only)
// ---------------------------------------------------------------------------

const PENDING_AUTHORIZATION_KEY = "ovo.runtime.pendingAuthorization";
