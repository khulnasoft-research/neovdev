...
These apps are shared development fixtures. They are real ovo apps that CI or
...
- `agent-tui-client` backs the non-e2e TUI smoke scripts in `packages/ovo/test/tui-client`.
