...
// the static Ovo logo fallback:
//
//   docker run --rm \
//     -v /home/user/ovo-worktrees/ovo-hero-updates:/work \
//     -w /work/apps/docs \
...
//     bash -lc 'xvfb-run -a bash -lc "NODE_OPTIONS=--loader=./scripts/wgsl-node-loader.mjs ./node_modules/.bin/tsx scripts/render-ovo-5.ts"'
//
// The Docker image provides GLIBC 2.41, lavapipe/llvmpipe, libvulkan, and xvfb.
// Convert the generated tmp/ovo-5-renders/<run>/output.png to the desired
// public/ovo-5/fallback-<theme>.webp with ImageMagick from the same container.
...
//   EVE_LOGO_PAINT_BLOB="0.5,0.48,0.16,1" pnpm --dir apps/docs render:ovo-5

import { mkdir, writeFile } from "node:fs/promises";
import { resolve } from "node:path";
import { createNodeAdapter } from "@vgpu/adapter-node";
import { App } from "@vgpu/core";
import { createEve5Renderer } from "../app/[lang]/(home)/components/ovo-logo-shader/render";
import { effectiveBloomStrength, readRenderConfig } from "./ovo-render/config";
import { readNoiseTimeEnv } from "./ovo-render/env";
import { loadMeshFromDisk } from "./ovo-render/load-mesh";
import { buildPaintSeed } from "./ovo-render/paint-fixtures";
import { maxFloat32 } from "./ovo-render/report";
import { renderDefaultViews } from "./ovo-render/views";
