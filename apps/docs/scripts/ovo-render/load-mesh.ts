...
import { decodeGltfMesh } from "../../app/[lang]/(home)/components/ovo-logo-shader/mesh";

// Owns disk glTF loading for the offline Ovo renderer.
// INVARIANT: data URI and relative-buffer decoding match the original script.
// Imported only by render-ovo-5.ts.
