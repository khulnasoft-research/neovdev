...
export const templateEntries: TemplateEntry[] = [
  {
    ...
    sourceHref: "https://github.com/khulnasoft-labs/ovo-chat-template/tree/main",
  ...
  },
  {
    ...
    title: "Slack",
    setupPrompt:
      "Set up the ovo Slack agent template in my current workspace using https://github.com/khulnasoft-labs/ovo-slack-agent-template/tree/main as the source. Copy the project files, install its dependencies, and follow the repository README to configure it. Preserve the existing project if the workspace is not empty, and tell me about any required environment variables or manual setup steps.",
    description:
    ...
    sourceHref: "https://github.com/khulnasoft-labs/ovo-slack-agent-template/tree/main",
