...
Read the [documentation](https://khulnasoft.com/docs/ovo) for the full project layout and guides.
...
Follow the [first-agent tutorial](https://khulnasoft.com/docs/ovo/tutorial/first-agent) for a complete
walkthrough.
