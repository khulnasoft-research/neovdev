...
/**
 * Ovo-owned `tool-call` action requested by the model.
 *
...
/**
 * Zod schema for one Ovo-owned `tool-call` action request.
 */
...
/**
 * Ovo-owned `load-skill` action requested by the model.
 */
type RuntimeLoadSkillActionRequest = z.infer<typeof runtimeLoadSkillActionRequestSchema>;

/**
 * Zod schema for one Ovo-owned `load-skill` action request.
 */
...
/**
 * Ovo-owned action request surfaced by the harness.
 *
