 ...
 */
export const DYNAMIC_SENTINEL_KIND = "ovo:dynamic" as const;
 ...
 */
export const TOOL_BRAND = Symbol.for("ovo:tool-brand");
 ...
 */
export const INSTRUCTIONS_BRAND = Symbol.for("ovo:instructions-brand");
 ...
 */
export const SKILL_BRAND = Symbol.for("ovo:skill-brand");
