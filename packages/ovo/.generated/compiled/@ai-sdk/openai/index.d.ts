...
} from "#compiled/@ai-sdk/provider-utils/index.js";
...
type OpenAILanguageModelCompletionOptions = InferSchema<
...
type OpenAIResponsesLogprobs = NonNullable<
  (OpenAIResponsesChunk & {
    type: "response.output_text.delta";
  })["logprobs"]
> | null;

declare const customToolFactory: _ai_sdk_provider_utils.ProviderDefinedToolFactory<
  string,
  {
    /**
...
declare const openaiTools: {
   ...
   */
  customTool: (
    args: Parameters<typeof customToolFactory>[0],
  ) => _ai_sdk_provider_utils.ProviderDefinedTool<string, unknown, {}>;
  /**
  ...
  computer: (
    options?: Parameters<
      _ai_sdk_provider_utils.ProviderDefinedToolFactoryWithOutputSchema<
        {
      ...
      >
    >[0],
  ) => _ai_sdk_provider_utils.ProviderDefinedTool<
    {
      actions: OpenAIComputerAction[];
      pendingSafetyChecks: OpenAIComputerSafetyCheck[];
      status: "in_progress" | "completed" | "incomplete";
...
type OpenAILanguageModelResponsesOptions = InferSchema<
...
declare class OpenAIRealtimeModel implements Experimental_RealtimeModelV4 {
  ...
  doCreateClientSecret(
    options: Experimental_RealtimeModelV4ClientSecretOptions,
  ): Promise<Experimental_RealtimeModelV4ClientSecretResult>;
...
declare const safetyCheckSchema: z.ZodObject<
  ...
  z.core.$strip
>;
declare const computerActionSchema: z.ZodDiscriminatedUnion<
  [
    z.ZodObject<
      {
...
export {
  ...
  type OpenAIRealtimeModelConfig as Experimental_OpenAIRealtimeModelConfig,
  type OpenAILanguageModelChatOptions as OpenAIChatLanguageModelOptions,
  ...
  type OpenAILanguageModelResponsesOptions as OpenAIResponsesProviderOptions,
