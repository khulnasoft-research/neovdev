...
declare const ElicitResultSchema: z.ZodObject<
  {
    _meta: z.ZodOptional<z.ZodObject<{}, z.core.$loose>>;
    action: z.ZodUnion<
      readonly [z.ZodLiteral<"accept">, z.ZodLiteral<"decline">, z.ZodLiteral<"cancel">]
    >;
 ...
 */
declare function readMCPAppResource({
  client,
  uri,
  options,
}: {
...
export {
  ...
  type MCPAppResourceMeta,
  type MCPClient,
  type ClientCapabilities as MCPClientCapabilities,
  ...
  type ClientCapabilities as experimental_MCPClientCapabilities,
