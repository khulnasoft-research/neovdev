...
declare const anthropicLanguageModelOptions: z.ZodObject<
  {
    ...
    structuredOutputMode: z.ZodOptional<
      z.ZodEnum<{
        ...
        z.ZodObject<
          {
            ...
            toolConfiguration: z.ZodOptional<
              z.ZodNullable<
                z.ZodObject<
                  {
    ...
    contextManagement: z.ZodOptional<
      z.ZodObject<
        {
          edits: z.ZodArray<
            z.ZodDiscriminatedUnion<
...
declare function bash_20241022(
...
declare function bash_20250124(
...
declare const anthropicTools: {
  ...
  advisor_20260301: (
    args: Parameters<
      _ai_sdk_provider_utils.ProviderExecutedToolFactory<
        {},
        | {
            type: "advisor_result";
            text: string;
  ...
  textEditor_20250728: (
    args?: Parameters<
      _ai_sdk_provider_utils.ProviderDefinedToolFactory<
        {
          command: "view" | "create" | "str_replace" | "insert";
          path: string;
          file_text?: string;
 ...
 */
declare function forwardAnthropicContainerIdFromLastStep({
  steps,
}: {
  steps: Array<{
...
export {
  ...
  type AnthropicLanguageModelOptions as AnthropicProviderOptions,
