...
type GoogleLanguageModelInteractionsOptions = InferSchema<
...
declare class GoogleRealtimeModel implements Experimental_RealtimeModelV4 {
  ...
  serializeClientEvent(
    event: Experimental_RealtimeModelV4ClientEvent,
  ): ReturnType<Experimental_RealtimeModelV4["serializeClientEvent"]>;
...
export {
  ...
  type GoogleRealtimeModelConfig as Experimental_GoogleRealtimeModelConfig,
  type GoogleRealtimeModelId as Experimental_GoogleRealtimeModelId,
  type GoogleRealtimeModelOptions as Experimental_GoogleRealtimeModelOptions,
  type GoogleEmbeddingModelOptions,
  type GoogleErrorData,
  type GoogleFilesUploadOptions,
  type GoogleEmbeddingModelOptions as GoogleGenerativeAIEmbeddingProviderOptions,
  type GoogleImageModelOptions as GoogleGenerativeAIImageProviderOptions,
  type GoogleProvider as GoogleGenerativeAIProvider,
  type GoogleProviderMetadata as GoogleGenerativeAIProviderMetadata,
  ...
  type GoogleVideoModelOptions as GoogleGenerativeAIVideoProviderOptions,
