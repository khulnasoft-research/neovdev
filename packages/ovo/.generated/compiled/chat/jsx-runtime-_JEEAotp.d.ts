 ...
 * ```
 */
declare function Image(options: { url: string; alt?: string }): ImageElement;
/**
 ...
 * ```
 */
declare function Field(options: { label: string; value: string }): FieldElement;
/**
 ...
 * ```
 */
declare function CardLink(options: { url: string; label: string }): LinkElement;
/**
 ...
 */
declare function jsx<P extends CardJSXProps>(
  type: CardComponentFunction,
  props: P & {
    children?: unknown;
  },
 ...
 */
declare function jsxs<P extends CardJSXProps>(
  type: CardComponentFunction,
  props: P & {
    children?: unknown;
  },
 ...
 */
declare function Fragment(props: { children?: unknown }): CardChild[];
/**
...
export {
  type FieldProps as $,
  type ActionsComponent as A,
  type ButtonComponent as B,
  type CardElement as C,
  type DividerComponent as D,
  type ExternalSelectComponent as E,
  type FieldComponent as F,
  type CardOptions as G,
  type CardProps as H,
  type ImageComponent as I,
  type ChartDataPoint as J,
  type ChartDefinition as K,
  type LinkButtonComponent as L,
  type ModalComponent as M,
  type ChartOptions as N,
  type ChartSegment as O,
  type ChartSeries as P,
  type ChatElement as Q,
  type RadioSelectComponent as R,
  type SectionComponent as S,
  type TextComponent as T,
  type ContainerProps as U,
  type DividerElement as V,
  type DividerProps as W,
  type ExternalSelectElement as X,
  type ExternalSelectOptions as Y,
  type ExternalSelectProps as Z,
  type FieldElement as _,
  type CardChild as a,
  type FieldsElement as a0,
  type ImageElement as a1,
  type ImageProps as a2,
  type LinkButtonElement as a3,
  type LinkButtonOptions as a4,
  type LinkButtonProps as a5,
  type LinkElement as a6,
  type ModalChild as a7,
  type ModalElement as a8,
  type ModalOptions as a9,
  jsx as aA,
  jsxDEV as aB,
  jsxs as aC,
  type ModalProps as aa,
  type PieChartDefinition as ab,
  type RadioSelectElement as ac,
  type RadioSelectOptions as ad,
  type SectionElement as ae,
  type SelectElement as af,
  type SelectOptionElement as ag,
  type SelectOptionProps as ah,
  type SelectOptions as ai,
  type SelectProps as aj,
  type SeriesChartDefinition as ak,
  type TableAlignment as al,
  type TableElement as am,
  type TableOptions as an,
  type TextElement as ao,
  type TextInputElement as ap,
  type TextInputOptions as aq,
  type TextInputProps as ar,
  type TextProps as as,
  type TextStyle as at,
  type ChartProps as au,
  Fragment as av,
  JSX as aw,
  type TableComponent as ax,
  type TableProps as ay,
  isCardLinkProps as az,
  type ChartElement as b,
  type CardComponent as c,
  type CardLinkComponent as d,
  type ChartComponent as e,
  type FieldsComponent as f,
  type SelectComponent as g,
  type SelectOptionComponent as h,
  Table as i,
  type TextInputComponent as j,
  cardChildToFallbackText as k,
  fromReactElement as l,
  fromReactModalElement as m,
  isCardElement as n,
  isJSX as o,
  isModalElement as p,
  toModalElement as q,
  type ActionsElement as r,
  type ButtonElement as s,
  toCardElement as t,
  type ButtonOptions as u,
  type ButtonProps as v,
  type ButtonStyle as w,
  type CardJSXElement as x,
  type CardJSXProps as y,
  type CardLinkProps as z,
};
