var e = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), (e = null)), t.exports),
  ...
  r = e((e, r) => {
    let { MAX_SAFE_COMPONENT_LENGTH: i, MAX_SAFE_BUILD_LENGTH: a, MAX_LENGTH: o } = t(),
      s = n();
    e = r.exports = {};
    let c = (e.re = []),
      l = (e.safeRe = []),
    ...
    (_(`NUMERICIDENTIFIER`, `0|[1-9]\\d*`),
      ...
      _(
        `MAINVERSION`,
        `(${u[f.NUMERICIDENTIFIER]})\\.(${u[f.NUMERICIDENTIFIER]})\\.(${u[f.NUMERICIDENTIFIER]})`,
      ),
      _(
        `MAINVERSIONLOOSE`,
        `(${u[f.NUMERICIDENTIFIERLOOSE]})\\.(${u[f.NUMERICIDENTIFIERLOOSE]})\\.(${u[f.NUMERICIDENTIFIERLOOSE]})`,
      ),
      _(`PRERELEASEIDENTIFIER`, `(?:${u[f.NONNUMERICIDENTIFIER]}|${u[f.NUMERICIDENTIFIER]})`),
      _(
      ...
      _(
        `PRERELEASELOOSE`,
        `(?:-?(${u[f.PRERELEASEIDENTIFIERLOOSE]}(?:\\.${u[f.PRERELEASEIDENTIFIERLOOSE]})*))`,
      ),
      _(`BUILDIDENTIFIER`, `${m}+`),
      ...
      _(`COERCEPLAIN`, `(^|[^\\d])(\\d{1,${i}})(?:\\.(\\d{1,${i}}))?(?:\\.(\\d{1,${i}}))?`),
      ...
      _(
        `HYPHENRANGELOOSE`,
        `^\\s*(${u[f.XRANGEPLAINLOOSE]})\\s+-\\s+(${u[f.XRANGEPLAINLOOSE]})\\s*$`,
      ),
      _(`STAR`, `(<|>)?=?\\s*\\*`),
      _(`GTE0`, `^\\s*>=\\s*0\\.0\\.0\\s*$`),
  ...
  o = e((e, o) => {
    let s = n(),
      { MAX_LENGTH: c, MAX_SAFE_INTEGER: l } = t(),
      { safeRe: u, t: d } = r(),
      f = i(),
      { compareIdentifiers: p } = a(),
      m = (e, t) => {
        let n = t.split(`.`);
    ...
    o.exports = class e {
      constructor(t, n) {
        ...
        if (t.length > c) throw TypeError(`version is longer than ${c} characters`);
        (s(`SemVer`, t, n),
          (this.options = n),
          (this.loose = !!n.loose),
          (this.includePrerelease = !!n.includePrerelease));
        let r = t.trim().match(n.loose ? u[d.LOOSE] : u[d.FULL]);
      ...
      compare(t) {
        if ((s(`SemVer.compare`, this.version, this.options, t), !(t instanceof e))) {
      ...
      comparePre(t) {
        ...
        do {
          let e = this.prerelease[n],
            r = t.prerelease[n];
          if ((s(`prerelease compare`, n, e, r), e === void 0 && r === void 0)) return 0;
      ...
      compareBuild(t) {
        ...
        do {
          let e = this.build[n],
            r = t.build[n];
          if ((s(`build compare`, n, e, r), e === void 0 && r === void 0)) return 0;
          if (r === void 0) return 1;
          if (e === void 0) return -1;
          if (e === r) continue;
          return p(e, r);
      ...
      inc(e, t, n) {
        if (e.startsWith(`pre`)) {
          ...
          if (t) {
            let e = `-${t}`.match(this.options.loose ? u[d.PRERELEASELOOSE] : u[d.PRERELEASE]);
  ...
  k = e((e, t) => {
    ...
    t.exports = (e, t) => {
      ...
      t ||= {};
      let r = null;
      if (!t.rtl) r = e.match(t.includePrerelease ? a[c.COERCEFULL] : a[c.COERCE]);
      else {
        let n = t.includePrerelease ? a[c.COERCERTLFULL] : a[c.COERCERTL],
          i;
      ...
      let o = r[2];
      return i(
        `${o}.${r[3] || `0`}.${r[4] || `0`}${t.includePrerelease && r[5] ? `-${r[5]}` : ``}${t.includePrerelease && r[6] ? `+${r[6]}` : ``}`,
        t,
      );
    };
  }),
  A = e((e, n) => {
    let r = s(),
      ...
      a = o(),
      c = (e, t, n) => {
        if (!i.RELEASE_TYPES.includes(t)) return null;
        let r = l(e, n);
        return r && u(r, t);
      },
      l = (e, t) => r(e instanceof a ? e.version : e, t),
      u = (e, t) => {
        if (d(t)) return e.version;
    ...
    a.exports = class e {
      constructor(t, n) {
        ...
        if (this.set.length > 1) {
          let e = this.set[0];
          if (((this.set = this.set.filter((e) => !S(e[0]))), this.set.length === 0))
            this.set = [e];
      ...
      parseRange(e) {
        e = e.replace(x, ``);
        let t = ((this.options.includePrerelease && y) | (this.options.loose && b)) + `:` + e,
          n = c.get(t);
        if (n) return n;
        let r = this.options.loose,
          i = r ? p[h.HYPHENRANGELOOSE] : p[h.HYPHENRANGE];
        ((e = e.replace(i, R(this.options.includePrerelease))),
          d(`hyphen replace`, e),
          (e = e.replace(p[h.COMPARATORTRIM], g)),
          d(`comparator trim`, e),
          (e = e.replace(p[h.TILDETRIM], _)),
          d(`tilde trim`, e),
          (e = e.replace(p[h.CARETTRIM], v)),
          d(`caret trim`, e));
        let a = e
          .split(` `)
        ...
        (r &&
          (a = a.filter(
            (e) => (d(`loose invalid filter`, e, this.options), !!e.match(p[h.COMPARATORLOOSE])),
          )),
          d(`range list`, a));
        let o = new Map(),
          s = a.map((e) => new u(e, this.options));
        for (let e of s) {
          if (S(e)) return [e];
          o.set(e.value, e);
        }
      ...
      intersects(t, n) {
        ...
        return this.set.some(
          (e) =>
            w(e, n) &&
            t.set.some((t) => w(t, n) && e.every((e) => t.every((t) => e.intersects(t, n)))),
        );
      }
      test(e) {
        if (!e) return !1;
        ...
        for (let t = 0; t < this.set.length; t++) if (z(this.set[t], e, this.options)) return !0;
        return !1;
      }
    };
    let c = new (j())(),
      ...
      { FLAG_INCLUDE_PRERELEASE: y, FLAG_LOOSE: b } = t(),
      x = new RegExp(m[h.BUILD], `g`),
      S = (e) => e.value === `<0.0.0-0`,
      C = (e) => e.value === ``,
      w = (e, t) => {
        let n = !0,
      ...
      O = (e, t) =>
        e
          ...
          .join(` `),
      k = (e, t) => {
        let n = t.loose ? p[h.TILDELOOSE] : p[h.TILDE];
      ...
      M = (e, t) => {
        d(`caret`, e, t);
        let n = t.loose ? p[h.CARETLOOSE] : p[h.CARET],
      ...
      F = (e, t) => {
        e = e.trim();
        let n = t.loose ? p[h.XRANGELOOSE] : p[h.XRANGE];
        return e.replace(n, (n, r, i, a, o, s) => {
          if ((d(`xRange`, e, n, r, i, a, o, s), D(i, a, o))) return e;
          let c = E(i),
            l = c || E(a),
            u = l || E(o),
            f = u;
      ...
      I = (e, t) => (d(`replaceStars`, e, t), e.trim().replace(p[h.STAR], ``)),
      L = (e, t) => (
        d(`replaceGTE0`, e, t),
        e.trim().replace(p[t.includePrerelease ? h.GTE0PRE : h.GTE0], ``)
      ),
      R = (e) => (t, n, r, i, a, o, s, c, l, u, d, f) => (
        (n = E(r)
          ? ``
          : E(i)
            ? `>=${r}.0.0${e ? `-0` : ``}`
  ...
  N = e((e, t) => {
    ...
    t.exports = class e {
      ...
      parse(e) {
        let t = this.options.loose ? c[l.COMPARATORLOOSE] : c[l.COMPARATOR],
          n = e.match(t);
        if (!n) throw TypeError(`Invalid comparator: ${e}`);
        ((this.operator = n[1] === void 0 ? `` : n[1]),
          this.operator === `=` && (this.operator = ``),
          n[2] ? (this.semver = new f(n[2], this.options.loose)) : (this.semver = a));
      }
      toString() {
        return this.value;
      }
      test(e) {
        if ((d(`Comparator.test`, e, this.options.loose), this.semver === a || e === a)) return !0;
        if (typeof e == `string`)
          try {
            e = new f(e, this.options);
          } catch {
