...
var a = (() => {
  ...
  pe = i(O, `u`).replace(/punct/g, w).getRegex(),
  me = i(O, `u`).replace(/punct/g, D).getRegex(),
  ...
  M = i(/^!?\[(ref)\](?:\[\])?/)
    .replace(`ref`, g)
    .getRegex(),
  Te = i(`reflink|nolink(?!\\()`, `g`).replace(`reflink`, j).replace(`nolink`, M).getRegex(),
  N = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,
  P = {
    _backpedal: r,
    anyPunctuation: be,
    autolink: xe,
  ...
  I = { normal: b, gfm: ae, pedantic: oe },
  L = { normal: P, gfm: F, breaks: De, pedantic: Ee },
  Oe = { "&": `&amp;`, "<": `&lt;`, ">": `&gt;`, '"': `&quot;`, "'": `&#39;` },
  R = (e) => Oe[e];
function z(e, t) {
  if (t) {
    if (o.escapeTest.test(e)) return e.replace(o.escapeReplace, R);
  } else if (o.escapeTestNoEncode.test(e)) return e.replace(o.escapeReplaceNoEncode, R);
  return e;
}
function B(e) {
  try {
...
`),
        ...
        for (let e of i.items) {
          if (
            ((this.lexer.state.top = !1), (e.tokens = this.lexer.blockTokens(e.text, [])), e.task)
          ) {
            if (
...
`
  ...
  G = class e {
    ...
    constructor(e) {
      ...
      let n = { other: o, block: I.normal, inline: L.normal };
      (this.options.pedantic
        ? ((n.block = I.pedantic), (n.inline = L.pedantic))
        : this.options.gfm &&
          ((n.block = I.gfm), this.options.breaks ? (n.inline = L.breaks) : (n.inline = L.gfm)),
        (this.tokenizer.rules = n));
    }
    static get rules() {
      return { block: I, inline: L };
    }
    static lex(t, n) {
          ...
          if (e.hooks) {
            ...
            for (let n in e.hooks) {
              ...
              Y.passThroughHooks.has(n)
                ? (t[r] = (e) => {
                    if (this.defaults.async && Y.passThroughHooksRespectAsync.has(n))
                      return (async () => {
        ...
        if ((i.hooks && ((i.hooks.options = i), (i.hooks.block = e)), i.async))
          return (async () => {
            let n = i.hooks ? await i.hooks.preprocess(t) : t,
              r = await (i.hooks ? await i.hooks.provideLexer(e) : e ? G.lex : G.lexInline)(n, i),
              a = i.hooks ? await i.hooks.processAllTokens(r) : r;
            i.walkTokens && (await Promise.all(this.walkTokens(a, i.walkTokens)));
            let o = await (i.hooks ? await i.hooks.provideParser(e) : e ? J.parse : J.parseInline)(
              a,
              i,
            );
