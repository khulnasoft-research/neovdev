...
var __commonJSMin = (e, t) => () => (
  ...
  require_kind_of = __commonJSMin((e, t) => {
    ...
    t.exports = function (e) {
      ...
      if (t === `function`) return c(e) ? `generatorfunction` : `function`;
      if (i(e)) return `array`;
      if (d(e)) return `buffer`;
    ...
    function u(e) {
      try {
        ...
        if (e.message.indexOf(`callee`) !== -1) return !0;
      }
      return !1;
    }
    function d(e) {
  ...
  require_is_extendable = __commonJSMin((e, t) => {
    t.exports = function (e) {
      return e != null && (typeof e == `object` || typeof e == `function`);
    };
  }),
  require_extend_shallow = __commonJSMin((e, t) => {
    var n = require_is_extendable();
    t.exports = function (e) {
      n(e) || (e = {});
  ...
  require_section_matter = __commonJSMin((e, t) => {
    var n = require_kind_of(),
      r = require_extend_shallow();
    t.exports = function (e, t) {
      typeof t == `function` && (t = { parse: t });
      var n = a(e),
        l = r({}, { section_delimiter: `---`, parse: c }, t),
        u = l.section_delimiter,
        d = n.content.split(/\r?\n/),
        f = null,
        p = s(),
        m = [],
...
`),
    ...
    function a(e) {
      if (
        (n(e) !== `object` && (e = { content: e }), typeof e.content != `string` && !l(e.content))
      )
  ...
  require_common = __commonJSMin((e, t) => {
    function n(e) {
      return e == null;
    }
    function r(e) {
  ...
  require_exception = __commonJSMin((e, t) => {
    function n(e, t) {
      (Error.call(this),
  ...
  require_mark = __commonJSMin((e, t) => {
    var n = require_common();
...
` + t)),
  ...
  require_type = __commonJSMin((e, t) => {
    var n = require_exception(),
      r = [
        `kind`,
        `resolve`,
        `construct`,
  ...
  require_str = __commonJSMin((e, t) => {
    t.exports = new (require_type())(`tag:yaml.org,2002:str`, {
      kind: `scalar`,
  ...
  require_seq = __commonJSMin((e, t) => {
    t.exports = new (require_type())(`tag:yaml.org,2002:seq`, {
      kind: `sequence`,
      construct: function (e) {
        return e === null ? [] : e;
      },
  ...
  require_map = __commonJSMin((e, t) => {
    t.exports = new (require_type())(`tag:yaml.org,2002:map`, {
      kind: `mapping`,
      construct: function (e) {
        return e === null ? {} : e;
      },
  ...
  require_failsafe = __commonJSMin((e, t) => {
    t.exports = new (require_schema())({ explicit: [require_str(), require_seq(), require_map()] });
  }),
  require_null = __commonJSMin((e, t) => {
    var n = require_type();
    function r(e) {
      if (e === null) return !0;
      var t = e.length;
  ...
  require_bool = __commonJSMin((e, t) => {
    var n = require_type();
    function r(e) {
      if (e === null) return !1;
      var t = e.length;
  ...
  require_int = __commonJSMin((e, t) => {
    ...
    function s(e) {
      ...
      return !r || s === `_` ? !1 : s === `:` ? /^(:[0-5]?[0-9])+$/.test(e.slice(n)) : !0;
    }
    function c(e) {
      var t = e,
        n = 1,
  ...
  require_float = __commonJSMin((e, t) => {
    var n = require_common(),
      r = require_type(),
      i = RegExp(
  ...
  require_json = __commonJSMin((e, t) => {
    t.exports = new (require_schema())({
      include: [require_failsafe()],
      implicit: [require_null(), require_bool(), require_int(), require_float()],
    });
  }),
  require_core = __commonJSMin((e, t) => {
    t.exports = new (require_schema())({ include: [require_json()] });
  }),
  require_timestamp = __commonJSMin((e, t) => {
    var n = require_type(),
      r = RegExp(`^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$`),
      i = RegExp(
    ...
    function o(e) {
      var t,
        ...
        p,
        m;
      if (((t = r.exec(e)), t === null && (t = i.exec(e)), t === null))
      ...
      return (
        t[9] &&
          ((f = +t[10]), (p = +(t[11] || 0)), (d = (f * 60 + p) * 6e4), t[9] === `-` && (d = -d)),
        (m = new Date(Date.UTC(n, a, o, s, c, l, u))),
  ...
  require_merge = __commonJSMin((e, t) => {
    var n = require_type();
    function r(e) {
      return e === `<<` || e === null;
    }
    t.exports = new n(`tag:yaml.org,2002:merge`, { kind: `scalar`, resolve: r });
  }),
  require_binary = __commonJSMin((e, t) => {
    var n;
    try {
      n = __require(`buffer`).Buffer;
    } catch {}
    var r = require_type(),
...
\r`;
    ...
    function o(e) {
      var t,
        ...
        l = [];
      for (t = 0; t < o; t++)
        (t % 4 == 0 && t && (l.push((c >> 16) & 255), l.push((c >> 8) & 255), l.push(c & 255)),
          (c = (c << 6) | s.indexOf(a.charAt(t))));
      return (
        (r = (o % 4) * 6),
        r === 0
          ? (l.push((c >> 16) & 255), l.push((c >> 8) & 255), l.push(c & 255))
          : r === 18
            ? (l.push((c >> 10) & 255), l.push((c >> 2) & 255))
            : r === 12 && l.push((c >> 4) & 255),
  ...
  require_omap = __commonJSMin((e, t) => {
    var n = require_type(),
    ...
    t.exports = new n(`tag:yaml.org,2002:omap`, { kind: `sequence`, resolve: a, construct: o });
  }),
  require_pairs = __commonJSMin((e, t) => {
    var n = require_type(),
    ...
    function i(e) {
      ...
      for (o = Array(s.length), t = 0, n = s.length; t < n; t += 1) {
        if (((i = s[t]), r.call(i) !== `[object Object]` || ((a = Object.keys(i)), a.length !== 1)))
          return !1;
        o[t] = [a[0], i[a[0]]];
      }
      return !0;
    ...
    t.exports = new n(`tag:yaml.org,2002:pairs`, { kind: `sequence`, resolve: i, construct: a });
  }),
  require_set = __commonJSMin((e, t) => {
    var n = require_type(),
      r = Object.prototype.hasOwnProperty;
    function i(e) {
      if (e === null) return !0;
    ...
    t.exports = new n(`tag:yaml.org,2002:set`, { kind: `mapping`, resolve: i, construct: a });
  }),
  require_default_safe = __commonJSMin((e, t) => {
    t.exports = new (require_schema())({
  ...
  require_undefined = __commonJSMin((e, t) => {
    var n = require_type();
    function r() {
      return !0;
    }
  ...
  require_regexp = __commonJSMin((e, t) => {
    var n = require_type();
    function r(e) {
      ...
      var t = e,
        ...
        r = ``;
      return !(
        t[0] === `/` && (n && (r = n[1]), r.length > 3 || t[t.length - r.length - 1] !== `/`)
      );
    }
    function i(e) {
      var t = e,
  ...
  require_esprima = __commonJSMin((e, t) => {
    (function (n, r) {
        ...
        function (e, t, n) {
          ...
          function s(e, t, n) {
            var o = null,
              ...
              c = typeof n == `function` ? s : null,
              l = !1;
            if (t) {
              l = typeof t.comment == `boolean` && t.comment;
              var u = typeof t.attachComment == `boolean` && t.attachComment;
              (l || u) && ((o = new r.CommentHandler()), (o.attach = u), (t.comment = !0), (c = s));
            }
            var d = !1;
            t && typeof t.sourceType == `string` && (d = t.sourceType === `module`);
            var f =
                t && typeof t.jsx == `boolean` && t.jsx
                  ? new i.JSXParser(e, t, c)
                  : new a.Parser(e, t, c),
              p = d ? f.parseModule() : f.parseScript();
            return (
              l && o && (p.comments = o.comments),
          ...
          ((t.tokenize = u), (t.Syntax = n(2).Syntax), (t.version = `4.0.1`));
        },
        function (e, t, n) {
          Object.defineProperty(t, "__esModule", { value: !0 });
          var r = n(2);
          t.CommentHandler = (function () {
            function e() {
              ((this.attach = !1),
                (this.comments = []),
                (this.stack = []),
            ...
            return (
                ...
                if (e.type === r.Syntax.BlockStatement && e.body.length === 0) {
                  for (var n = [], i = this.leading.length - 1; i >= 0; --i) {
                    ...
                    t.end.offset >= a.start &&
                      (n.unshift(a.comment), this.leading.splice(i, 1), this.trailing.splice(i, 1));
                  }
              ...
              (e.prototype.findLeadingComments = function (e) {
                for (var t = [], n; this.stack.length > 0;) {
                  ...
                  if (r && r.start >= e.start.offset) ((n = r.node), this.stack.pop());
                  else break;
                }
                if (n) {
                  for (
                    var i = (n.leadingComments ? n.leadingComments.length : 0) - 1;
                    i >= 0;
                    --i
                  ) {
                    var a = n.leadingComments[i];
                    a.range[1] <= e.start.offset && (t.unshift(a), n.leadingComments.splice(i, 1));
                  }
                  return (
                    n.leadingComments && n.leadingComments.length === 0 && delete n.leadingComments,
                    t
                  );
                }
                for (var i = this.leading.length - 1; i >= 0; --i) {
                  var r = this.leading[i];
                  r.start <= e.start.offset && (t.unshift(r.comment), this.leading.splice(i, 1));
                }
                return t;
              }),
              ...
              (e.prototype.visit = function (e, t) {
                e.type === `LineComment` || e.type === `BlockComment`
          ...
          t.JSXParser = (function (e) {
            ...
            return (
              ...
              (t.prototype.scanXHTMLEntity = function (e) {
                for (var t = `&`, n = !0, r = !1, a = !1, o = !1; !this.scanner.eof() && n && !r;) {
                  ...
                  if (((r = s === `;`), (t += s), ++this.scanner.index, !r))
                    switch (t.length) {
                      ...
                      case 3:
                        a &&
                          ((o = s === `x`),
                          (n = o || i.Character.isDecimalDigit(s.charCodeAt(0))),
                          (a &&= !o));
                        break;
                      default:
                        ((n &&= !(a && !i.Character.isDecimalDigit(s.charCodeAt(0)))),
                          (n &&= !(o && !i.Character.isHexDigit(s.charCodeAt(0)))));
                        break;
                    }
                }
                if (n && r && t.length > 2) {
                  ...
                  a && c.length > 1
                    ...
                    : o && c.length > 2
                      ...
                      : !a && !o && u.XHTMLEntities[c] && (t = u.XHTMLEntities[c]);
                }
                return t;
              }),
              (t.prototype.lexJSX = function () {
                ...
                if (e === 34 || e === 39) {
                  for (
                    ...
                    if (o === r) break;
                    o === `&` ? (a += this.scanXHTMLEntity(r)) : (a += o);
                  }
                  return {
                    type: 8,
                    value: a,
                ...
                if (e === 46) {
                  var s = this.scanner.source.charCodeAt(this.scanner.index + 1),
                    c = this.scanner.source.charCodeAt(this.scanner.index + 2),
                    t = s === 46 && c === 46 ? `...` : `.`,
                ...
                if (i.Character.isIdentifierStart(e) && e !== 92) {
                  ...
                  for (++this.scanner.index; !this.scanner.eof();) {
                    ...
                    if (i.Character.isIdentifierPart(o) && o !== 92) ++this.scanner.index;
                    else if (o === 45) ++this.scanner.index;
                    else break;
                  }
                  return {
                    type: 100,
...
` &&
                ...
                return (
                  t.length > 0 && this.config.tokens && this.tokens.push(this.convertToken(r)), r
                );
              }),
              ...
              (t.prototype.parseJSXIdentifier = function () {
                var e = this.createJSXNode(),
                  t = this.nextJSXToken();
                return (
                  t.type !== 100 && this.throwUnexpectedToken(t),
              ...
              (t.prototype.parseJSXOpeningElement = function () {
                ...
                return (
                  r && this.expectJSX(`/`),
                  this.expectJSX(`>`),
                  this.finalize(e, new a.JSXOpeningElement(t, r, n))
                );
              }),
              (t.prototype.parseJSXBoundaryElement = function () {
                ...
                return (
                  i && this.expectJSX(`/`),
                  this.expectJSX(`>`),
                  this.finalize(e, new a.JSXOpeningElement(n, i, r))
                );
              }),
              ...
              (t.prototype.parseJSXExpressionContainer = function () {
                ...
                return (
                  this.matchJSX(`}`)
                    ? ((t = this.parseJSXEmptyExpression()), this.expectJSX(`}`))
                    : (this.finishJSX(), (t = this.parseAssignmentExpression()), this.reenterJSX()),
              ...
              (t.prototype.parseComplexJSXElement = function (e) {
                for (var t = []; !this.scanner.eof();) {
                  ...
                  if (r.type === o.JSXSyntax.JSXOpeningElement) {
                    var i = r;
                    if (i.selfClosing) {
                      var s = this.finalize(n, new a.JSXElement(i, [], null));
                      e.children.push(s);
                    } else (t.push(e), (e = { node: n, opening: i, closing: null, children: [] }));
                  }
                  if (r.type === o.JSXSyntax.JSXClosingElement) {
                    e.closing = r;
                    var c = d(e.opening.name);
                    if (
                      (c !== d(e.closing.name) &&
                      ...
                      ((e = t[t.length - 1]), e.children.push(s), t.pop());
                    } else break;
                  }
                }
                return e;
        ...
        function (e, t, n) {
          ...
          ((t.JSXClosingElement = (function () {
            ...
            (t.JSXExpressionContainer = (function () {
              function e(e) {
            ...
            (t.JSXMemberExpression = (function () {
              function e(e, t) {
        ...
        function (e, t, n) {
          ...
          ((t.ArrayExpression = (function () {
            ...
            (t.AssignmentPattern = (function () {
              function e(e, t) {
                ((this.type = r.Syntax.AssignmentPattern), (this.left = e), (this.right = t));
              }
              return e;
            })()),
            (t.AsyncArrowFunctionExpression = (function () {
              function e(e, t, n) {
                ((this.type = r.Syntax.ArrowFunctionExpression),
                  (this.id = null),
                  (this.params = e),
            ...
            (t.AsyncFunctionDeclaration = (function () {
              function e(e, t, n) {
            ...
            (t.AsyncFunctionExpression = (function () {
              function e(e, t, n) {
            ...
            (t.AwaitExpression = (function () {
              function e(e) {
                ((this.type = r.Syntax.AwaitExpression), (this.argument = e));
              }
              return e;
            })()),
            (t.BinaryExpression = (function () {
              function e(e, t, n) {
                var i = e === `||` || e === `&&`;
            ...
            (t.BlockStatement = (function () {
              function e(e) {
                ((this.type = r.Syntax.BlockStatement), (this.body = e));
              }
              return e;
            })()),
            (t.BreakStatement = (function () {
              function e(e) {
            ...
            (t.ComputedMemberExpression = (function () {
              function e(e, t) {
            ...
            (t.RestElement = (function () {
              function e(e) {
                ((this.type = r.Syntax.RestElement), (this.argument = e));
              }
              return e;
            })()),
            (t.ReturnStatement = (function () {
              function e(e) {
            ...
            (t.SpreadElement = (function () {
              function e(e) {
                ((this.type = r.Syntax.SpreadElement), (this.argument = e));
              }
              return e;
            })()),
            (t.StaticMemberExpression = (function () {
              function e(e, t) {
                ((this.type = r.Syntax.MemberExpression),
                  (this.computed = !1),
                  (this.object = e),
            ...
            (t.VariableDeclaration = (function () {
              function e(e, t) {
          ...
          t.Parser = (function () {
            ...
            return (
              ...
              (e.prototype.unexpectedTokenError = function (e, t) {
                var n = t || a.Messages.UnexpectedToken,
                  r;
                if (
                  (e
                    ? (t ||
                        ...
                        e.type === 4 &&
                          (this.scanner.isFutureReservedWord(e.value)
                            ? (n = a.Messages.UnexpectedReserved)
                            : this.context.strict &&
                    ...
                    : (r = `ILLEGAL`),
                  (n = n.replace(`%0`, r)),
                  e && typeof e.lineNumber == `number`)
                ) {
                  var i = e.start,
                    o = e.lineNumber,
                    s = this.lastMarker.index - this.lastMarker.column,
                    c = e.start - s + 1;
                  return this.errorHandler.createError(i, o, c, n);
                } else {
              ...
              (e.prototype.convertToken = function (e) {
                ...
                return (
                  ...
                  e.type === 9 && (t.regex = { pattern: e.pattern, flags: e.flags }),
                  t
                );
              }),
              (e.prototype.nextToken = function () {
                ...
                return (
                  ...
                  t &&
                    ...
                    (t.type = 4),
                  (this.lookahead = t),
                  this.config.tokens && t.type !== 2 && this.tokens.push(this.convertToken(t)),
                  e
                );
              }),
                ...
                switch (this.lookahead.type) {
                  case 3:
                    ((this.context.isModule || this.context.await) &&
                      ...
                      (t = this.matchAsyncFunction()
                        ...
                        : this.finalize(e, new o.Identifier(this.nextToken().value))));
                    break;
                  case 6:
                  case 8:
                    (this.context.strict &&
                  ...
                  case 1:
                    ((this.context.isAssignmentTarget = !1),
                      ...
                      (n = this.nextToken()),
                      (r = this.getTokenRaw(n)),
                      (t = this.finalize(e, new o.Literal(n.value === `true`, r))));
                    break;
                  case 5:
                    ((this.context.isAssignmentTarget = !1),
                      (this.context.isBindingElement = !1),
                      (n = this.nextToken()),
                      (r = this.getTokenRaw(n)),
                      (t = this.finalize(e, new o.Literal(null, r))));
                    break;
                  case 10:
                    ...
                    switch (this.lookahead.value) {
                      ...
                      case `/=`:
                        ((this.context.isAssignmentTarget = !1),
                          ...
                          (t = this.finalize(
                            e,
                            new o.RegexLiteral(n.regex, r, n.pattern, n.flags),
                          )));
                        break;
                      default:
                        ...
                        : ((this.context.isAssignmentTarget = !1),
                          ...
                          this.matchKeyword(`function`)
                            ...
                            : this.matchKeyword(`this`)
                              ? (this.nextToken(), (t = this.finalize(e, new o.ThisExpression())))
              ...
              (e.prototype.parsePropertyMethodFunction = function () {
                ...
                return (
                  ...
                  this.finalize(t, new o.FunctionExpression(null, r.params, i, e))
                );
              }),
              (e.prototype.parsePropertyMethodAsyncFunction = function () {
                ...
                return (
                  ...
                  this.finalize(e, new o.AsyncFunctionExpression(null, r.params, i))
                );
              }),
              (e.prototype.parseObjectPropertyKey = function () {
                ...
                switch (t.type) {
                  ...
                  case 6:
                    ...
                    n = this.finalize(e, new o.Literal(t.value, r));
                    break;
                  case 3:
                  case 1:
                  case 5:
                  case 4:
                    n = this.finalize(e, new o.Identifier(t.value));
                    break;
                  case 7:
                    t.value === `[`
              ...
              (e.prototype.isPropertyKey = function (e, t) {
                return (
                  (e.type === c.Syntax.Identifier && e.name === t) ||
                  (e.type === c.Syntax.Literal && e.value === t)
                );
              }),
                ...
                if (n.type === 3) {
                  ...
                  (this.nextToken(),
                    ...
                    (i = d
                      ...
                      : this.finalize(t, new o.Identifier(f))));
                } else
                  this.match(`*`)
                    ? this.nextToken()
                    : ((c = this.match(`[`)), (i = this.parseObjectPropertyKey()));
                var p = this.qualifiedPropertyName(this.lookahead);
                if (n.type === 3 && !d && n.value === `get` && p)
                  ((r = `get`),
                    (c = this.match(`[`)),
                    (i = this.parseObjectPropertyKey()),
                    (this.context.allowYield = !1),
                    (s = this.parseGetterMethod()));
                else if (n.type === 3 && !d && n.value === `set` && p)
                  ((r = `set`),
                    (c = this.match(`[`)),
                    (i = this.parseObjectPropertyKey()),
                  ...
                  (!c &&
                    ...
                    (e.value && this.tolerateError(a.Messages.DuplicateProtoProperty),
                    (e.value = !0)),
                    this.nextToken(),
                  ...
                  var f = this.finalize(t, new o.Identifier(n.value));
                  if (this.match(`=`)) {
                    ((this.context.firstCoverInitializedNameError = this.lookahead),
                      this.nextToken(),
                      (u = !0));
                    var m = this.isolateCoverGrammar(this.parseAssignmentExpression);
                    s = this.finalize(t, new o.AssignmentPattern(f, m));
                  } else ((u = !0), (s = f));
                } else this.throwUnexpectedToken(this.nextToken());
                return this.finalize(t, new o.Property(r, i, c, s, l, u));
              }),
              ...
              (e.prototype.parseTemplateHead = function () {
                ...
                var e = this.createNode(),
                  ...
                  n = t.value,
                  i = t.cooked;
                return this.finalize(e, new o.TemplateElement({ raw: n, cooked: i }, t.tail));
              }),
              (e.prototype.parseTemplateElement = function () {
                ...
                var e = this.createNode(),
                  ...
                  n = t.value,
                  r = t.cooked;
                return this.finalize(e, new o.TemplateElement({ raw: n, cooked: r }, t.tail));
              }),
                ...
                switch (e.type) {
                  ...
                  case c.Syntax.ArrayExpression:
                    ...
                    for (var t = 0; t < e.elements.length; t++)
                      e.elements[t] !== null && this.reinterpretExpressionAsPattern(e.elements[t]);
                    break;
                  case c.Syntax.ObjectExpression:
                    e.type = c.Syntax.ObjectPattern;
              ...
              (e.prototype.parseArguments = function () {
                ...
                if (!this.match(`)`))
                  for (;;) {
                    ...
                    if (
                      (e.push(t), this.match(`)`) || (this.expectCommaSeparator(), this.match(`)`)))
                    )
                      break;
                  }
                ...
                for (
                  ...
                  if (this.match(`.`)) {
                    ((this.context.isBindingElement = !1),
                      ...
                      this.expect(`.`));
                    var i = this.parseIdentifierName();
                    r = this.finalize(this.startNode(e), new o.StaticMemberExpression(r, i));
                  } else if (this.match(`(`)) {
                    var a = t && e.lineNumber === this.lookahead.lineNumber;
                    ((this.context.isBindingElement = !1), (this.context.isAssignmentTarget = !1));
                    var s = a ? this.parseAsyncArguments() : this.parseArguments();
                    if (
                      ((r = this.finalize(this.startNode(e), new o.CallExpression(r, s))),
                      a && this.match(`=>`))
                    ) {
                      for (var c = 0; c < s.length; ++c) this.reinterpretExpressionAsPattern(s[c]);
                      r = { type: u, params: s, async: !0 };
                    }
                  } else if (this.match(`[`)) {
                    ((this.context.isBindingElement = !1),
                      (this.context.isAssignmentTarget = !0),
                    ...
                    (this.expect(`]`),
                      (r = this.finalize(this.startNode(e), new o.ComputedMemberExpression(r, i))));
                  } else if (this.lookahead.type === 10 && this.lookahead.head) {
                    var l = this.parseTemplateLiteral();
                    r = this.finalize(this.startNode(e), new o.TaggedTemplateExpression(r, l));
                  } else break;
              ...
              (e.prototype.parseUpdateExpression = function () {
                ...
                if (this.match(`++`) || this.match(`--`)) {
                  ...
                  var i = !0;
                  ((e = this.finalize(n, new o.UpdateExpression(r.value, e, i))),
                    (this.context.isAssignmentTarget = !1),
                    (this.context.isBindingElement = !1));
                } else if (
                  ((e = this.inheritCoverGrammar(this.parseLeftHandSideExpressionAllowCall)),
                  !this.hasLineTerminator &&
                    this.lookahead.type === 7 &&
                  ...
                  var s = this.nextToken().value,
                    i = !1;
                  e = this.finalize(this.startNode(t), new o.UpdateExpression(s, e, i));
                }
                return e;
              }),
              ...
              (e.prototype.binaryPrecedence = function (e) {
                ...
                return e.type === 7
                  ...
                  : e.type === 4 && (t === `instanceof` || (this.context.allowIn && t === `in`))
                    ? 7
                    : 0;
              }),
                ...
                if (r > 0) {
                  ...
                  for (
                    var i = [e, this.lookahead],
                      ...
                      c = [a, n.value, s],
                      l = [r];
                    (r = this.binaryPrecedence(this.lookahead)), !(r <= 0);
                  ) {
                    for (; c.length > 2 && r <= l[l.length - 1];) {
                      s = c.pop();
                      var u = c.pop();
                      (l.pop(), (a = c.pop()), i.pop());
                      var d = this.startNode(i[i.length - 1]);
                      c.push(this.finalize(d, new o.BinaryExpression(u, a, s)));
                    }
                  ...
                  for (var p = i.pop(); f > 1;) {
                    var m = i.pop(),
                      h = p && p.lineStart,
                      d = this.startNode(m, h),
                      u = c[f - 1];
                    ((t = this.finalize(d, new o.BinaryExpression(u, c[f - 2], t))),
                      (f -= 2),
                      (p = m));
                  }
                }
              ...
              (e.prototype.parseConditionalExpression = function () {
                ...
                if (this.match(`?`)) {
                  ...
                  ((t = this.finalize(this.startNode(e), new o.ConditionalExpression(t, r, i))),
                    (this.context.isAssignmentTarget = !1),
                    (this.context.isBindingElement = !1));
                }
                return t;
                ...
                switch (t.type) {
                  ...
                  case c.Syntax.ArrayPattern:
                    for (var n = 0; n < t.elements.length; n++)
                      t.elements[n] !== null && this.checkPatternParam(e, t.elements[n]);
                    break;
              ...
              (e.prototype.reinterpretAsCoverFormalsList = function (e) {
                ...
                for (var i = 0; i < t.length; ++i) {
                  var o = t[i];
                  (o.type === c.Syntax.AssignmentPattern
                    ? o.right.type === c.Syntax.YieldExpression &&
                      (o.right.argument && this.throwUnexpectedToken(this.lookahead),
                      (o.right.type = c.Syntax.Identifier),
                      (o.right.name = `yield`),
                      delete o.right.argument,
                      delete o.right.delegate)
                    : r &&
                      o.type === c.Syntax.Identifier &&
                      o.name === `await` &&
                      this.throwUnexpectedToken(this.lookahead),
                    this.checkPatternParam(n, o),
                    (t[i] = o));
                }
                if (this.context.strict || !this.context.allowYield)
                  for (var i = 0; i < t.length; ++i) {
                    var o = t[i];
                    o.type === c.Syntax.YieldExpression &&
                      this.throwUnexpectedToken(this.lookahead);
                  }
                if (n.message === a.Messages.StrictParamDupe) {
                  var s = this.context.strict ? n.stricted : n.firstRestricted;
                  this.throwUnexpectedToken(s, n.message);
                }
                return {
                  simple: n.simple,
                  params: t,
                  ...
                  if (e.type === u || this.match(`=>`)) {
                    ...
                    if (s) {
                      ...
                      (this.context.strict &&
                        ...
                        (e = i
                          ? this.finalize(m, new o.AsyncArrowFunctionExpression(s.params, h, _))
                          : this.finalize(m, new o.ArrowFunctionExpression(s.params, h, _))),
                    ...
                    if (
                      ...
                      (this.scanner.isRestrictedWord(v.name) &&
                        this.tolerateUnexpectedToken(n, a.Messages.StrictLHSAssignment),
                        this.scanner.isStrictModeReservedWord(v.name) &&
                          this.tolerateUnexpectedToken(n, a.Messages.StrictReservedWord));
                    }
                    (this.match(`=`)
                    ...
                    ((e = this.finalize(this.startNode(t), new o.AssignmentExpression(y, e, b))),
                      (this.context.firstCoverInitializedNameError = null));
                  }
                }
                return e;
              ...
              (e.prototype.parseExpression = function () {
                ...
                if (this.match(`,`)) {
                  var n = [];
                  for (n.push(t); this.lookahead.type !== 2 && this.match(`,`);)
                    (this.nextToken(),
              ...
              (e.prototype.parsePropertyPattern = function (e, t) {
                ...
                if (this.lookahead.type === 3) {
                  ...
                  var u = this.finalize(n, new o.Identifier(l.value));
                  if (this.match(`=`)) {
                    (e.push(l), (i = !0), this.nextToken());
                    var d = this.parseAssignmentExpression();
                    c = this.finalize(this.startNode(l), new o.AssignmentPattern(u, d));
                  } else
                    this.match(`:`)
                      ? (this.expect(`:`), (c = this.parsePatternWithDefault(e, t)))
                      : (e.push(l), (i = !0), (c = u));
                } else
                  ((r = this.match(`[`)),
                    (s = this.parseObjectPropertyKey()),
                    this.expect(`:`),
                    (c = this.parsePatternWithDefault(e, t)));
                return this.finalize(n, new o.Property(`init`, s, r, c, a, i));
              }),
              ...
              (e.prototype.parsePatternWithDefault = function (e, t) {
                ...
                if (this.match(`=`)) {
                  ...
                  ((this.context.allowYield = i),
                    (r = this.finalize(this.startNode(n), new o.AssignmentPattern(r, a))));
                }
                return r;
              }),
                  ...
                  n.type === 4 && n.value === `yield`
                    ...
                    : n.type === 3
                      ...
                      : this.context.strict &&
                        ...
                        ? this.tolerateUnexpectedToken(n, a.Messages.StrictReservedWord)
                        : (this.context.strict || n.value !== `let` || e !== `var`) &&
              ...
              (e.prototype.parseVariableStatement = function () {
                ...
                return (
                  this.consumeSemicolon(), this.finalize(e, new o.VariableDeclaration(t, `var`))
                );
              }),
              ...
              (e.prototype.parseIfStatement = function () {
                ...
                return (
                  ...
                  this.finalize(e, new o.IfStatement(r, t, n))
                );
              }),
              ...
              (e.prototype.parseForStatement = function () {
                ...
                if ((this.expectKeyword(`for`), this.expect(`(`), this.match(`;`)))
                  ...
                  ((e = this.createNode()), this.nextToken());
                  var u = this.context.allowIn;
                  this.context.allowIn = !1;
                  var d = this.parseVariableDeclarationList({ inFor: !0 });
                  if (((this.context.allowIn = u), d.length === 1 && this.matchKeyword(`in`))) {
                    var f = d[0];
                    (f.init &&
                      (f.id.type === c.Syntax.ArrayPattern ||
                        f.id.type === c.Syntax.ObjectPattern ||
                        this.context.strict) &&
                      this.tolerateError(a.Messages.ForInOfLoopInitializer, `for-in`),
                      (e = this.finalize(e, new o.VariableDeclaration(d, `var`))),
                      this.nextToken(),
                      (i = e),
                      (s = this.parseExpression()),
                      (e = null));
                  } else
                    d.length === 1 && d[0].init === null && this.matchContextualKeyword(`of`)
                      ? ((e = this.finalize(e, new o.VariableDeclaration(d, `var`))),
                        this.nextToken(),
                        (i = e),
                  ...
                  if (!this.context.strict && this.lookahead.value === `in`)
                    ((e = this.finalize(e, new o.Identifier(p))),
                      this.nextToken(),
                      (i = e),
                      (s = this.parseExpression()),
                      (e = null));
                    ...
                    var u = this.context.allowIn;
                    this.context.allowIn = !1;
                    var d = this.parseBindingList(p, { inFor: !0 });
                    ((this.context.allowIn = u),
                      d.length === 1 && d[0].init === null && this.matchKeyword(`in`)
                        ? ((e = this.finalize(e, new o.VariableDeclaration(d, p))),
                          this.nextToken(),
                          (i = e),
                          (s = this.parseExpression()),
                          (e = null))
                  ...
                  if (
                    ...
                    ((!this.context.isAssignmentTarget ||
                      e.type === c.Syntax.AssignmentExpression) &&
                    ...
                    if (this.match(`,`)) {
                      for (var h = [e]; this.match(`,`);)
                        (this.nextToken(),
                          h.push(this.isolateCoverGrammar(this.parseAssignmentExpression)));
                      e = this.finalize(this.startNode(m), new o.SequenceExpression(h));
                    }
                    this.expect(`;`);
                  }
                }
                i === void 0 &&
                  (this.match(`;`) || (t = this.parseExpression()),
                  this.expect(`;`),
                  this.match(`)`) || (n = this.parseExpression()));
                var g;
                if (!this.match(`)`) && this.config.tolerant)
                  (this.tolerateUnexpectedToken(this.nextToken()),
                    (g = this.finalize(this.createNode(), new o.EmptyStatement())));
                else {
                  this.expect(`)`);
                  var _ = this.context.inIteration;
                  ((this.context.inIteration = !0),
                    (g = this.isolateCoverGrammar(this.parseStatement)),
                    (this.context.inIteration = _));
                }
                return i === void 0
                  ? this.finalize(l, new o.ForStatement(e, t, n, g))
                  : r
                    ? this.finalize(l, new o.ForInStatement(i, s, g))
                    : this.finalize(l, new o.ForOfStatement(i, s, g));
              }),
              ...
              (e.prototype.parseSwitchStatement = function () {
                ...
                for (this.expect(`{`); !this.match(`}`);) {
                  ...
                  (s.test === null &&
                    (i && this.throwError(a.Messages.MultipleDefaultsInSwitch), (i = !0)),
                    r.push(s));
                }
                return (
                  this.expect(`}`),
              ...
              (e.prototype.parseLabelledStatement = function () {
                var e = this.createNode(),
                  t = this.parseExpression(),
                  n;
                if (t.type === c.Syntax.Identifier && this.match(`:`)) {
                  this.nextToken();
                  var r = t,
                    i = `$` + r.name;
                  ...
                  if (this.matchKeyword(`class`))
                    ...
                    var l = this.lookahead,
                      u = this.parseFunctionDeclaration();
                    (this.context.strict
                      ? this.tolerateUnexpectedToken(l, a.Messages.StrictFunction)
                      : u.generator &&
                        this.tolerateUnexpectedToken(l, a.Messages.GeneratorInLegacyContext),
                      (s = u));
                  } else s = this.parseStatement();
                  (delete this.context.labelSet[i], (n = new o.LabeledStatement(r, s)));
                } else (this.consumeSemicolon(), (n = new o.ExpressionStatement(t)));
                return this.finalize(e, n);
              }),
              ...
              (e.prototype.parseCatchClause = function () {
                ...
                for (var t = [], n = this.parsePattern(t), r = {}, i = 0; i < t.length; i++) {
                  ...
                  (Object.prototype.hasOwnProperty.call(r, s) &&
                    this.tolerateError(a.Messages.DuplicateBinding, t[i].value),
                    (r[s] = !0));
                }
                (this.context.strict &&
                  n.type === c.Syntax.Identifier &&
                ...
                return this.finalize(e, new o.CatchClause(n, l));
              }),
              ...
              (e.prototype.validateParam = function (e, t, n) {
                ...
                (this.context.strict
                  ? (this.scanner.isRestrictedWord(n) &&
                      ((e.stricted = t), (e.message = a.Messages.StrictParamName)),
                    Object.prototype.hasOwnProperty.call(e.paramSet, r) &&
                      ((e.stricted = t), (e.message = a.Messages.StrictParamDupe)))
                  : e.firstRestricted ||
                    (this.scanner.isRestrictedWord(n)
                      ? ((e.firstRestricted = t), (e.message = a.Messages.StrictParamName))
                      : this.scanner.isStrictModeReservedWord(n)
                        ? ((e.firstRestricted = t), (e.message = a.Messages.StrictReservedWord))
                        : Object.prototype.hasOwnProperty.call(e.paramSet, r) &&
                          ((e.stricted = t), (e.message = a.Messages.StrictParamDupe))),
              ...
              (e.prototype.parseFormalParameters = function (e) {
                var t = { simple: !0, params: [], firstRestricted: e };
                if ((this.expect(`(`), !this.match(`)`)))
                  for (
                    t.paramSet = {};
                    this.lookahead.type !== 2 &&
                    (this.parseFormalParameter(t),
                    !(this.match(`)`) || (this.expect(`,`), this.match(`)`))));
                  );
                return (
                  this.expect(`)`),
                  {
              ...
              (e.prototype.parseFunctionDeclaration = function (e) {
                  ...
                  ((s = this.parseVariableIdentifier()),
                    this.context.strict
                      ? this.scanner.isRestrictedWord(l.value) &&
                        this.tolerateUnexpectedToken(l, a.Messages.StrictFunctionName)
                      : this.scanner.isRestrictedWord(l.value)
                        ? ((c = l), (i = a.Messages.StrictFunctionName))
                        : this.scanner.isStrictModeReservedWord(l.value) &&
                          ((c = l), (i = a.Messages.StrictReservedWord)));
                }
                ...
                var f = this.parseFormalParameters(c),
                  p = f.params,
                  m = f.stricted;
                ((c = f.firstRestricted), f.message && (i = f.message));
                var h = this.context.strict,
                  g = this.context.allowStrictDirective;
                this.context.allowStrictDirective = f.simple;
                var _ = this.parseFunctionSourceElements();
                return (
                  this.context.strict && c && this.throwUnexpectedToken(c, i),
                  this.context.strict && m && this.tolerateUnexpectedToken(m, i),
                  (this.context.strict = h),
                  (this.context.allowStrictDirective = g),
                  (this.context.await = u),
                  (this.context.allowYield = d),
                  n
                    ? this.finalize(t, new o.AsyncFunctionDeclaration(s, p, _))
                    : this.finalize(t, new o.FunctionDeclaration(s, p, _, r))
                );
              }),
              (e.prototype.parseFunctionExpression = function () {
                ...
                if (((this.context.await = t), (this.context.allowYield = !n), !this.match(`(`))) {
                  ...
                  ((i =
                    ...
                    this.context.strict
                      ...
                      : this.scanner.isRestrictedWord(u.value)
                        ? ((s = u), (r = a.Messages.StrictFunctionName))
                        : this.scanner.isStrictModeReservedWord(u.value) &&
                          ((s = u), (r = a.Messages.StrictReservedWord)));
                }
                var d = this.parseFormalParameters(s),
                  f = d.params,
                  p = d.stricted;
                ((s = d.firstRestricted), d.message && (r = d.message));
                ...
                return (
                  this.context.strict && s && this.throwUnexpectedToken(s, r),
                  ...
                  t
                    ? this.finalize(e, new o.AsyncFunctionExpression(i, f, g))
                    : this.finalize(e, new o.FunctionExpression(i, f, g, n))
                );
              }),
              (e.prototype.parseDirective = function () {
                ...
                return (
                  this.consumeSemicolon(),
                  this.finalize(t, r ? new o.Directive(n, r) : new o.ExpressionStatement(n))
                );
              }),
                ...
                for (var e = null, t = []; ;) {
                  ...
                  i === `use strict`
                    ? ((this.context.strict = !0),
                      e && this.tolerateUnexpectedToken(e, a.Messages.StrictOctalLiteral),
                      this.context.allowStrictDirective ||
                        this.tolerateUnexpectedToken(n, a.Messages.IllegalLanguageModeDirective))
                    : !e && n.octal && (e = n);
                }
                return t;
              }),
              ...
              (e.prototype.parseGetterMethod = function () {
                ...
                this.context.allowYield = !t;
                var r = this.parseFormalParameters();
                r.params.length > 0 && this.tolerateError(a.Messages.BadGetterArity);
                var i = this.parsePropertyMethod(r);
                return (
                  (this.context.allowYield = n),
                  this.finalize(e, new o.FunctionExpression(null, r.params, i, t))
                );
              }),
              (e.prototype.parseSetterMethod = function () {
                ...
                var r = this.parseFormalParameters();
                r.params.length === 1
                  ? r.params[0] instanceof o.RestElement &&
              ...
              (e.prototype.parseClassElement = function (e) {
                ...
                if (this.match(`*`)) this.nextToken();
                  ...
                  t.type === 3 && !this.hasLineTerminator && t.value === `async`)
                ) {
                  ...
                  c ||
                    ...
                    !u &&
                      ...
                      e.value
                        ...
                        : (e.value = !0),
                      (r = `constructor`))),
                  this.finalize(n, new o.MethodDefinition(i, c, s, r, u))
                );
              }),
              ...
              (e.prototype.parseClassDeclaration = function (e) {
                ...
                return (
                  (this.context.strict = n), this.finalize(t, new o.ClassDeclaration(r, i, a))
                );
              }),
              (e.prototype.parseClassExpression = function () {
                ...
                return (
                  (this.context.strict = t), this.finalize(e, new o.ClassExpression(n, r, i))
                );
              }),
              (e.prototype.parseModule = function () {
                ...
                for (
                  var e = this.createNode(), t = this.parseDirectivePrologues();
                  this.lookahead.type !== 2;
                )
                  t.push(this.parseStatementListItem());
                  ...
                  this.lookahead.type === 3
                    ? ((t = this.parseVariableIdentifier()),
                      ...
                      this.matchContextualKeyword(`as`) &&
                        (this.nextToken(), (n = this.parseVariableIdentifier())))
                    : ((t = this.parseIdentifierName()),
                      (n = t),
                      this.matchContextualKeyword(`as`)
                        ? (this.nextToken(), (n = this.parseVariableIdentifier()))
                        : this.throwUnexpectedToken(this.nextToken())),
                  this.finalize(e, new o.ImportSpecifier(n, t))
                );
              }),
              ...
              (e.prototype.parseImportDeclaration = function () {
                ...
                return (this.consumeSemicolon(), this.finalize(e, new o.ImportDeclaration(n, t)));
              }),
              ...
              (e.prototype.parseExportDeclaration = function () {
                ...
                if (this.matchKeyword(`default`))
                  if ((this.nextToken(), this.matchKeyword(`function`))) {
                    ...
                    t = this.finalize(e, new o.ExportDefaultDeclaration(n));
                  ...
                  (this.consumeSemicolon(), (t = this.finalize(e, new o.ExportAllDeclaration(i))));
                  ...
                  t = this.finalize(e, new o.ExportNamedDeclaration(n, [], null));
                  ...
                  t = this.finalize(e, new o.ExportNamedDeclaration(null, s, c));
                }
                return t;
              }),
              e
            ...
            (t.ErrorHandler = (function () {
              ...
              return (
                ...
                (e.prototype.createError = function (e, t, n, r) {
                  ...
                  return ((a.index = e), (a.lineNumber = t), (a.description = r), a);
                }),
          ...
          t.Scanner = (function () {
            ...
            return (
              ...
              (e.prototype.throwUnexpectedToken = function (e) {
                return (
                  e === void 0 && (e = a.Messages.UnexpectedTokenIllegal),
              ...
              (e.prototype.skipSingleLineComment = function (e) {
                ...
                for (
                  ...
                  if ((++this.index, i.Character.isLineTerminator(a))) {
                    ...
                    return (
                      a === 13 && this.source.charCodeAt(this.index) === 10 && ++this.index,
                      ++this.lineNumber,
              ...
              (e.prototype.skipMultiLineComment = function () {
                ...
                for (
                  ...
                  if (i.Character.isLineTerminator(r))
                    (r === 13 && this.source.charCodeAt(this.index + 1) === 10 && ++this.index,
                      ++this.lineNumber,
                      ++this.index,
                      (this.lineStart = this.index));
                  else if (r === 42) {
              ...
              (e.prototype.scanComments = function () {
                var e;
                this.trackComment && (e = []);
                for (var t = this.index === 0; !this.eof();) {
              ...
              (e.prototype.codePointAt = function (e) {
                ...
                if (t >= 55296 && t <= 56319) {
                  ...
                  n >= 56320 && n <= 57343 && (t = (t - 55296) * 1024 + n - 56320 + 65536);
                }
                return t;
              }),
              (e.prototype.scanHexEscape = function (e) {
                for (var t = e === `u` ? 4 : 2, n = 0, r = 0; r < t; ++r)
              ...
              (e.prototype.scanUnicodeCodePointEscape = function () {
                ...
                for (
                  ...
                  !this.eof() &&
                  ((e = this.source[this.index++]), i.Character.isHexDigit(e.charCodeAt(0)));
                )
                  t = t * 16 + o(e);
                return (
              ...
              (e.prototype.getIdentifier = function () {
                for (var e = this.index++; !this.eof();) {
                  ...
                  if (t === 92 || (t >= 55296 && t < 57343))
                    return ((this.index = e), this.getComplexIdentifier());
                  if (i.Character.isIdentifierPart(t)) ++this.index;
                  else break;
                }
                ...
                for (
                  ...
                  this.source[this.index] === `{`
                    ...
                    : ((n = this.scanHexEscape(`u`)),
                      (n === null ||
                        n === `\\` ||
                        !i.Character.isIdentifierStart(n.charCodeAt(0))) &&
                        this.throwUnexpectedToken()),
                  (t = n));
                  !this.eof() &&
                  ((e = this.codePointAt(this.index)), i.Character.isIdentifierPart(e));
                )
                    ...
                    e === 92 &&
                      ...
                      this.source[this.index] === `{`
                        ...
                        : ((n = this.scanHexEscape(`u`)),
                          (n === null ||
                            n === `\\` ||
                            !i.Character.isIdentifierPart(n.charCodeAt(0))) &&
                            this.throwUnexpectedToken()),
                      (t += n)));
                return t;
              }),
              ...
              (e.prototype.scanHexLiteral = function (e) {
                for (
                  var t = ``;
                  !this.eof() && i.Character.isHexDigit(this.source.charCodeAt(this.index));
                )
                  t += this.source[this.index++];
                return (
                  t.length === 0 && this.throwUnexpectedToken(),
              ...
              (e.prototype.scanBinaryLiteral = function (e) {
                for (
                  var t = ``, n;
                  !this.eof() && ((n = this.source[this.index]), !(n !== `0` && n !== `1`));
                )
                  t += this.source[this.index++];
                return (
                  t.length === 0 && this.throwUnexpectedToken(),
                  this.eof() ||
                    ...
                    (i.Character.isIdentifierStart(n) || i.Character.isDecimalDigit(n)) &&
                      this.throwUnexpectedToken()),
                  {
                    type: 6,
                    value: parseInt(t, 2),
              ...
              (e.prototype.scanOctalLiteral = function (e, t) {
                ...
                return (
                  !r && n.length === 0 && this.throwUnexpectedToken(),
                  (i.Character.isIdentifierStart(this.source.charCodeAt(this.index)) ||
                ...
                for (var n = !1, o = ``; !this.eof();) {
                  ...
                  if (s === t) {
                    ...
                    if (
                      ...
                      !s || !i.Character.isLineTerminator(s.charCodeAt(0)))
                    )
                      switch (s) {
                        case `u`:
                          if (this.source[this.index] === `{`)
                            (++this.index, (o += this.scanUnicodeCodePointEscape()));
                          else {
                            var c = this.scanHexEscape(s);
                            (c === null && this.throwUnexpectedToken(), (o += c));
                          }
                          break;
                        case `x`:
...
`;
                        ...
                        default:
                          if (s && i.Character.isOctalDigit(s.charCodeAt(0))) {
                            var u = this.octalToDecimal(s);
                            ((n = u.octal || n), (o += String.fromCharCode(u.code)));
                          } else o += s;
                          break;
                      }
                    else
...
` &&
                          ++this.index,
                        (this.lineStart = this.index));
                  else if (i.Character.isLineTerminator(s.charCodeAt(0))) break;
                  else o += s;
                }
                return (
...
`;
                        ...
                        case `u`:
                          if (this.source[this.index] === `{`)
                            ...
                            var l = this.index,
                              u = this.scanHexEscape(c);
                            u === null ? ((this.index = l), (e += c)) : (e += u);
                          }
                          break;
                        case `x`:
                          var d = this.scanHexEscape(c);
                          (d === null &&
                            this.throwUnexpectedToken(a.Messages.InvalidHexEscapeSequence),
                            (e += d));
                          break;
...
`))
                ...
                t.indexOf(`u`) >= 0 &&
                  (r = r
                    .replace(/\\u\{([0-9a-fA-F]+)\}|\\u([a-fA-F0-9]{4})/g, function (e, t, r) {
                      ...
                      return (
                        o > 1114111 && i.throwUnexpectedToken(a.Messages.InvalidRegExp),
                        o <= 65535 ? String.fromCharCode(o) : n
                      );
                    })
                    .replace(/[\uD800-\uDBFF][\uDC00-\uDFFF]/g, n));
                try {
              ...
              (e.prototype.scanRegExpFlags = function () {
                for (var e = ``, t = ``; !this.eof();) {
                  ...
                  if (!i.Character.isIdentifierPart(n.charCodeAt(0))) break;
                  if ((++this.index, n === `\\` && !this.eof()))
                    if (((n = this.source[this.index]), n === `u`)) {
                      ++this.index;
                      var r = this.index,
                        a = this.scanHexEscape(`u`);
                      if (a !== null)
                        for (t += a, e += `\\u`; r < this.index; ++r) e += this.source[r];
                ...
                (e.prototype.isRegexStart = function () {
                  ...
                  switch (e) {
                    ...
                    case `)`:
                      ...
                      break;
                    case `}`:
                      if (((t = !1), this.values[this.curly - 3] === `function`)) {
                        var r = this.values[this.curly - 4];
                        t = r ? !this.beforeFunctionExpression(r) : !1;
                      } else if (this.values[this.curly - 4] === `function`) {
                        var r = this.values[this.curly - 5];
                        t = r ? !this.beforeFunctionExpression(r) : !0;
                      }
                      break;
                    default:
                      break;
          ...
          t.Tokenizer = (function () {
            function e(e, t) {
              ((this.errorHandler = new r.ErrorHandler()),
                ...
                (this.scanner.trackComment = t ? typeof t.comment == `boolean` && t.comment : !1),
                (this.trackRange = t ? typeof t.range == `boolean` && t.range : !1),
                (this.trackLoc = t ? typeof t.loc == `boolean` && t.loc : !1),
                (this.buffer = []),
                (this.reader = new o()));
            }
            return (
                  ...
                  if (!this.scanner.eof()) {
                    ...
                    (this.trackRange && (c.range = [s.start, s.end]),
                      this.trackLoc &&
                        ...
                        (c.loc = o)),
                      s.type === 9 && (c.regex = { pattern: s.pattern, flags: s.flags }),
                      this.buffer.push(c));
                  }
                }
  ...
  require_function = __commonJSMin((e, t) => {
    var n;
    try {
      n = require_esprima();
    } catch {
    ...
    function a(e) {
      ...
      return (
        ...
        r.body[0].expression.body.type === `BlockStatement`
          ? Function(i, t.slice(a[0] + 1, a[1] - 1))
          : Function(i, `return ` + t.slice(a[0], a[1]))
      );
    }
    function o(e) {
      return e.toString();
  ...
  require_default_full = __commonJSMin((e, t) => {
    var n = require_schema();
    t.exports = n.DEFAULT = new n({
      include: [require_default_safe()],
      explicit: [require_undefined(), require_regexp(), require_function()],
    });
  }),
  require_loader = __commonJSMin((e, t) => {
    var n = require_common(),
      r = require_exception(),
      i = require_mark(),
      a = require_default_safe(),
      o = require_default_full(),
...
`
    ...
    for (var k = Array(256), A = Array(256), j = 0; j < 256; j++) ((k[j] = +!!D(j)), (A[j] = D(j)));
    function ne(e, t) {
      ((this.input = e),
    ...
    function M(e, t) {
      return new r(t, new i(e.filename, e.input, e.position, e.line, e.position - e.lineStart));
    }
    function N(e, t) {
      throw M(e, t);
    }
    ...
    var F = {
      ...
      TAG: function (e, t, n) {
        ...
        (n.length !== 2 && N(e, `TAG directive accepts exactly two arguments`),
          (r = n[0]),
          (i = n[1]),
          v.test(r) || N(e, `ill-formed tag handle (first argument) of the TAG directive`),
          s.call(e.tagMap, r) &&
            N(e, `there is a previously declared suffix for "` + r + `" tag handle`),
          y.test(i) || N(e, `ill-formed tag prefix (second argument) of the TAG directive`),
          (e.tagMap[r] = i));
      },
    };
    function I(e, t, n, r) {
      ...
      if (t < n) {
        ...
        else h.test(s) && N(e, `the stream contains non-printable characters`);
        e.result += s;
      }
    }
    function L(e, t, r, i) {
      ...
      for (
        ...
        ((o = a[c]), s.call(t, o) || (te(t, o, r[o]), (i[o] = !0)));
    }
      ...
      if (Array.isArray(i))
        for (i = Array.prototype.slice.call(i), l = 0, u = i.length; l < u; l += 1)
          (Array.isArray(i[l]) && N(e, `nested arrays are not supported inside keys`),
            typeof i == `object` && b(i[l]) === `[object Object]` && (i[l] = `[object Object]`));
      if (
        (typeof i == `object` && b(i) === `[object Object]` && (i = `[object Object]`),
        (i = String(i)),
        t === null && (t = {}),
        r === `tag:yaml.org,2002:merge`)
      )
        if (Array.isArray(a)) for (l = 0, u = a.length; l < u; l += 1) L(e, t, a[l], n);
        else L(e, t, a, n);
      else
        (!e.json &&
          !s.call(n, i) &&
          s.call(t, i) &&
          ((e.line = o || e.line), (e.position = c || e.position), N(e, `duplicated mapping key`)),
          te(t, i, a),
          delete n[i]);
      return t;
    }
    ...
    function B(e, t, n) {
      for (var r = 0, i = e.input.charCodeAt(e.position); i !== 0;) {
        for (; S(i);) i = e.input.charCodeAt(++e.position);
        if (t && i === 35)
          do i = e.input.charCodeAt(++e.position);
          while (i !== 10 && i !== 13 && i !== 0);
        if (x(i))
          for (z(e), i = e.input.charCodeAt(e.position), r++, e.lineIndent = 0; i === 32;)
    ...
    function V(e) {
      ...
      return !!(
        ...
        ((t += 3), (n = e.input.charCodeAt(t)), n === 0 || C(n))
      );
    }
    function H(e, t) {
      t === 1
...
`,
    ...
    function U(e, t, n) {
      ...
      if (
        ...
        p === 64 ||
        p === 96 ||
        ((p === 63 || p === 45) && ((i = e.input.charCodeAt(e.position + 1)), C(i) || (n && w(i))))
      )
        return !1;
      for (e.kind = `scalar`, e.result = ``, a = o = e.position, s = !1; p !== 0;) {
        if (p === 58) {
          if (((i = e.input.charCodeAt(e.position + 1)), C(i) || (n && w(i)))) break;
        } else if (p === 35) {
          if (((r = e.input.charCodeAt(e.position - 1)), C(r))) break;
        } else if ((e.position === e.lineStart && V(e)) || (n && w(p))) break;
        else if (x(p))
          if (
            ((c = e.line), (l = e.lineStart), (u = e.lineIndent), B(e, !1, -1), e.lineIndent >= t)
          ) {
        ...
        ((s &&= (I(e, a, o, !1), H(e, e.line - c), (a = o = e.position), !1)),
          S(p) || (o = e.position + 1),
          (p = e.input.charCodeAt(++e.position)));
      }
    ...
    function W(e, t) {
      ...
      for (
        ...
        if (n === 39)
          if ((I(e, r, e.position, !0), (n = e.input.charCodeAt(++e.position)), n === 39))
            ((r = e.position), e.position++, (i = e.position));
          else return !0;
        else
          x(n)
            ? (I(e, r, i, !0), H(e, B(e, !1, t)), (r = i = e.position))
    ...
    function G(e, t) {
      ...
      for (
        ...
        if (s === 34) return (I(e, n, e.position, !0), e.position++, !0);
          ...
          if ((I(e, n, e.position, !0), (s = e.input.charCodeAt(++e.position)), x(s))) B(e, !1, t);
          else if (s < 256 && k[s]) ((e.result += A[s]), e.position++);
          else if ((o = T(s)) > 0) {
            for (i = o, a = 0; i > 0; i--)
              ((s = e.input.charCodeAt(++e.position)),
                (o = ee(s)) >= 0 ? (a = (a << 4) + o) : N(e, `expected hexadecimal character`));
            ((e.result += O(a)), e.position++);
          } else N(e, `unknown escape sequence`);
          n = r = e.position;
        } else
          x(s)
            ? (I(e, n, r, !0), H(e, B(e, !1, t)), (n = r = e.position))
            : e.position === e.lineStart && V(e)
    ...
    function K(e, t) {
      ...
      if (_ === 91) ((l = 93), (f = !1), (a = []));
      else if (_ === 123) ((l = 125), (f = !0), (a = {}));
      else return !1;
      for (
        e.anchor !== null && (e.anchorMap[e.anchor] = a), _ = e.input.charCodeAt(++e.position);
        _ !== 0;
      ) {
        if ((B(e, !0, t), (_ = e.input.charCodeAt(e.position)), _ === l))
          return (
            e.position++,
            (e.tag = i),
            (e.anchor = o),
        ...
        (n || N(e, `missed comma between flow collection entries`),
          (h = m = g = null),
          (u = d = !1),
          _ === 63 &&
            ((s = e.input.charCodeAt(e.position + 1)),
            C(s) && ((u = d = !0), e.position++, B(e, !0, t))),
          (r = e.line),
          Z(e, t, c, !1, !0),
          (h = e.tag),
          (m = e.result),
          ...
          (d || e.line === r) &&
            ...
            Z(e, t, c, !1, !0),
            (g = e.result)),
          f ? R(e, a, p, h, m, g) : u ? a.push(R(e, null, p, h, m, g)) : a.push(m),
          B(e, !0, t),
          (_ = e.input.charCodeAt(e.position)),
          _ === 44 ? ((n = !0), (_ = e.input.charCodeAt(++e.position))) : (n = !1));
      }
    ...
    function q(e, t) {
      ...
      for (e.kind = `scalar`, e.result = ``; h !== 0;)
        if (((h = e.input.charCodeAt(++e.position)), h === 43 || h === 45))
          f === a ? (a = h === 43 ? m : p) : N(e, `repeat of a chomping mode identifier`);
        else if ((d = E(h)) >= 0)
          d === 0
      ...
      for (; h !== 0;) {
        for (
          z(e), e.lineIndent = 0, h = e.input.charCodeAt(e.position);
          (!s || e.lineIndent < c) && h === 32;
        )
          (e.lineIndent++, (h = e.input.charCodeAt(++e.position)));
        if ((!s && e.lineIndent > c && (c = e.lineIndent), x(h))) {
          l++;
          continue;
        }
        if (e.lineIndent < c) {
...
`,
    ...
    function J(e, t) {
      ...
      for (
        ...
        c !== 0 && !(c !== 45 || ((o = e.input.charCodeAt(e.position + 1)), !C(o)));
      ) {
    ...
    function re(e, t, n) {
      var r,
        ...
        v;
      for (
        e.anchor !== null && (e.anchorMap[e.anchor] = u), v = e.input.charCodeAt(e.position);
        v !== 0;
      ) {
        if (
          ...
          (v === 63
            ? (g && (R(e, u, f, p, m, null), (p = m = h = null)), (_ = !0), (g = !0), (i = !0))
            : g
              ? ((g = !1), (i = !0))
              : N(
                  e,
          ...
          if (e.line === a) {
            for (v = e.input.charCodeAt(e.position); S(v);) v = e.input.charCodeAt(++e.position);
            if (v === 58)
        ...
        if (
          ((e.line === a || e.lineIndent > t) &&
            (Z(e, t, d, !0, i) && (g ? (m = e.result) : (h = e.result)),
            g || (R(e, u, f, p, m, h, a, o), (p = m = h = null)),
            B(e, !0, -1),
            (v = e.input.charCodeAt(e.position))),
          e.lineIndent > t && v !== 0)
        )
      ...
      return (
        g && R(e, u, f, p, m, null),
        _ && ((e.tag = s), (e.anchor = c), (e.kind = `mapping`), (e.result = u)),
        _
      );
    }
    function Y(e) {
          ...
          (o === 33 &&
            (r
              ...
              : ((i = e.input.slice(t - 1, e.position + 1)),
                v.test(i) || N(e, `named tag handle cannot contain such characters`),
                (r = !0),
                (t = e.position + 1))),
            (o = e.input.charCodeAt(++e.position)));
        ((a = e.input.slice(t, e.position)),
          _.test(a) && N(e, `tag suffix cannot contain flow indicator characters`));
      }
      return (
        a && !y.test(a) && N(e, `tag name cannot contain such characters: ` + a),
        n
          ? (e.tag = a)
          : s.call(e.tagMap, i)
            ? (e.tag = e.tagMap[i] + a)
    ...
    function ie(e) {
      ...
      if (r !== 42) return !1;
      for (r = e.input.charCodeAt(++e.position), t = e.position; r !== 0 && !C(r) && !w(r);)
        r = e.input.charCodeAt(++e.position);
      return (
        e.position === t && N(e, `name of an alias node must contain at least one character`),
        (n = e.input.slice(t, e.position)),
        s.call(e.anchorMap, n) || N(e, `unidentified alias "` + n + `"`),
    ...
    function Z(e, t, n, r, i) {
      ...
      if (
            ...
            ? (f && (J(e, b) || re(e, b, y))) || K(e, y)
              ...
              : ((o && q(e, y)) || W(e, y) || G(e, y)
                  ...
                  : ie(e)
                    ...
                    : U(e, y, c === n) && ((h = !0), e.tag === null && (e.tag = `?`)),
        ...
        if (e.tag === `?`) {
          ...
          s.call(e.typeMap[e.kind || `fallback`], e.tag)
      ...
      return (
        e.listener !== null && e.listener(`close`, e), e.tag !== null || e.anchor !== null || h
      );
    }
    function ae(e) {
      var t = e.position,
      ...
      for (
        ...
        (B(e, !0, -1), (o = e.input.charCodeAt(e.position)), !(e.lineIndent > 0 || o !== 37));
      ) {
        for (a = !0, o = e.input.charCodeAt(++e.position), n = e.position; o !== 0 && !C(o);)
          o = e.input.charCodeAt(++e.position);
        for (
          ...
          for (; S(o);) o = e.input.charCodeAt(++e.position);
          if (o === 35) {
            do o = e.input.charCodeAt(++e.position);
            while (o !== 0 && !x(o));
            break;
          ...
          if (x(o)) break;
          for (n = e.position; o !== 0 && !C(o);) o = e.input.charCodeAt(++e.position);
          i.push(e.input.slice(n, e.position));
        }
        (o !== 0 && z(e),
          s.call(F, r) ? F[r](e, r, i) : P(e, `unknown document directive "` + r + `"`));
      }
      if (
        (B(e, !0, -1),
        e.lineIndent === 0 &&
...
`),
    ...
    function ce(e, t, r) {
      return (
        typeof t == `object` && t && r === void 0 && ((r = t), (t = null)),
        oe(e, t, n.extend({ schema: a }, r))
      );
    }
    function le(e, t) {
      return se(e, n.extend({ schema: a }, t));
    }
    ((t.exports.loadAll = oe),
      (t.exports.load = se),
      (t.exports.safeLoadAll = ce),
      (t.exports.safeLoad = le));
  }),
  require_dumper = __commonJSMin((e, t) => {
    var n = require_common(),
      r = require_exception(),
      i = require_default_full(),
      a = require_default_safe(),
    ...
    function ne(e, t) {
      ...
      for (n = {}, r = Object.keys(t), i = 0, a = r.length; i < a; i += 1)
        ((o = r[i]),
          ...
          l && s.call(l.styleAliases, c) && (c = l.styleAliases[c]),
          (n[o] = c));
      return n;
    }
    function M(e) {
    ...
    function N(e) {
      ((this.schema = e.schema || i),
        ...
        (this.styleMap = ne(this.schema, e.styles || null)),
    ...
    function P(e, t) {
      for (var r = n.repeat(` `, t), i = 0, a = -1, o = ``, s, c = e.length; i < c;)
        ((a = e.indexOf(
          `
`,
          i,
        )),
          a === -1 ? ((s = e.slice(i)), (i = c)) : ((s = e.slice(i, a + 1)), (i = a + 1)),
          s.length &&
            s !==
              `
` &&
...
` + n.repeat(` `, e.indent * t)
    ...
    function z(e) {
      return R(e) && !L(e) && e !== 65279 && e !== u && e !== l;
    }
    function B(e, t) {
      return (
        R(e) &&
    ...
    function J(e, t, n, r, i) {
      var a,
        ...
        d = r !== -1,
        f = -1,
        p = V(e.charCodeAt(0)) && !L(e.charCodeAt(e.length - 1));
      if (t)
        for (a = 0; a < e.length; a++) {
          if (((o = e.charCodeAt(a)), !R(o))) return q;
          ((s = a > 0 ? e.charCodeAt(a - 1) : null), (p &&= B(o, s)));
        }
      else {
        for (a = 0; a < e.length; a++) {
          if (((o = e.charCodeAt(a)), o === l))
            ((c = !0), d && ((u ||= a - f - 1 > r && e[f + 1] !== ` `), (f = a)));
          else if (!R(o)) return q;
          ((s = a > 0 ? e.charCodeAt(a - 1) : null), (p &&= B(o, s)));
        }
        u ||= d && a - f - 1 > r && e[f + 1] !== ` `;
      }
      return !c && !u ? (p && !i(e) ? U : W) : n > 9 && H(e) ? q : u ? K : G;
    }
    function re(e, t, n, i) {
      e.dump = (function () {
        if (t.length === 0) return `''`;
        if (!e.noCompatMode && j.indexOf(t) !== -1) return `'` + t + `'`;
        ...
        switch (J(t, s, e.indent, o, c)) {
          case U:
            return t;
          case W:
            return `'` + t.replace(/'/g, `''`) + `'`;
          case G:
            return `|` + Y(t, e.indent) + X(P(t, a));
          case K:
            return `>` + Y(t, e.indent) + X(P(ie(t, o), a));
          case q:
            return `"` + ae(t, o) + `"`;
          default:
...
` +
    ...
    function ae(e) {
      for (var t = ``, n, r, i, a = 0; a < e.length; a++) {
        if (
          ((n = e.charCodeAt(a)),
          n >= 55296 && n <= 56319 && ((r = e.charCodeAt(a + 1)), r >= 56320 && r <= 57343))
        ) {
          ((t += M((n - 55296) * 1024 + r - 56320 + 65536)), a++);
          continue;
        }
        ((i = A[n]), (t += !i && R(n) ? e[a] : i || M(n)));
      }
      return t;
    }
    function Q(e, t, n) {
    ...
    function oe(e, t, n, r) {
      ...
      for (o = 0, s = n.length; o < s; o += 1)
        $(e, t + 1, n[o], !0, !0) &&
          ((!r || o !== 0) && (i += F(e, t)),
          e.dump && l === e.dump.charCodeAt(0) ? (i += `-`) : (i += `- `),
          (i += e.dump));
      ((e.tag = a), (e.dump = i || `[]`));
    }
    function se(e, t, n) {
      ...
      for (c = 0, u = s.length; c < u; c += 1)
        ((m = ``),
          ...
          $(e, t + 1, d, !0, !0, !0) &&
            ...
            p && (e.dump && l === e.dump.charCodeAt(0) ? (m += `?`) : (m += `? `)),
            (m += e.dump),
            p && (m += F(e, t)),
            $(e, t + 1, f, !0, p) &&
              (e.dump && l === e.dump.charCodeAt(0) ? (m += `:`) : (m += `: `),
              (m += e.dump),
              (a += m))));
      ((e.tag = o), (e.dump = a || `{}`));
    }
      ...
      for (c = 0, l = a.length; c < l; c += 1)
        if (
          ...
          (u.instanceOf || u.predicate) &&
            (!u.instanceOf || (typeof t == `object` && t instanceof u.instanceOf)) &&
            (!u.predicate || u.predicate(t)))
        ) {
          if (((e.tag = n ? u.tag : `?`), u.represent)) {
            if (
              ((d = e.styleMap[u.tag] || u.defaultStyle),
              o.call(u.represent) === `[object Function]`)
            )
              i = u.represent(t, d);
    ...
    function $(e, t, n, i, a, s) {
      ((e.tag = null), (e.dump = n), le(e, n, !1) || le(e, n, !0));
      var c = o.call(e.dump);
      i &&= e.flowLevel < 0 || e.flowLevel > t;
      var l = c === `[object Object]` || c === `[object Array]`,
        u,
        d;
      if (
        (l && ((u = e.duplicates.indexOf(n)), (d = u !== -1)),
        ((e.tag !== null && e.tag !== `?`) || d || (e.indent !== 2 && t > 0)) && (a = !1),
        d && e.usedDuplicates[u])
      )
        e.dump = `*ref_` + u;
      else {
        if ((l && d && !e.usedDuplicates[u] && (e.usedDuplicates[u] = !0), c === `[object Object]`))
          i && Object.keys(e.dump).length !== 0
            ? (ce(e, t, e.dump, a), d && (e.dump = `&ref_` + u + e.dump))
            : (se(e, t, e.dump), d && (e.dump = `&ref_` + u + ` ` + e.dump));
        else if (c === `[object Array]`) {
          var f = e.noArrayIndent && t > 0 ? t - 1 : t;
          i && e.dump.length !== 0
            ? (oe(e, f, e.dump, a), d && (e.dump = `&ref_` + u + e.dump))
            : (Q(e, f, e.dump), d && (e.dump = `&ref_` + u + ` ` + e.dump));
        } else if (c === `[object String]`) e.tag !== `?` && re(e, e.dump, t, s);
        else {
    ...
    function ue(e, t) {
      var n = [],
        ...
        i,
        a;
      for (de(e, n, r), i = 0, a = r.length; i < a; i += 1) t.duplicates.push(n[r[i]]);
    ...
    function de(e, t, n) {
      ...
      if (typeof e == `object` && e)
        if (((i = t.indexOf(e)), i !== -1)) n.indexOf(i) === -1 && n.push(i);
          ...
          for (i = 0, a = e.length; i < a; i += 1) de(e[i], t, n);
        else for (r = Object.keys(e), i = 0, a = r.length; i < a; i += 1) de(e[r[i]], t, n);
    }
    function fe(e, t) {
      t ||= {};
      var n = new N(t);
...
`
    ...
    function pe(e, t) {
      return fe(e, n.extend({ schema: a }, t));
    }
    ((t.exports.dump = fe), (t.exports.safeDump = pe));
  }),
  require_js_yaml$1 = __commonJSMin((e, t) => {
    var n = require_loader(),
      r = require_dumper();
    function i(e) {
      return function () {
        throw Error(`Function ` + e + ` is deprecated and cannot be used.`);
      };
    }
    ((t.exports.Type = require_type()),
      (t.exports.Schema = require_schema()),
      (t.exports.FAILSAFE_SCHEMA = require_failsafe()),
      (t.exports.JSON_SCHEMA = require_json()),
      (t.exports.CORE_SCHEMA = require_core()),
      (t.exports.DEFAULT_SAFE_SCHEMA = require_default_safe()),
      (t.exports.DEFAULT_FULL_SCHEMA = require_default_full()),
      ...
      (t.exports.YAMLException = require_exception()),
      (t.exports.MINIMAL_SCHEMA = require_failsafe()),
      (t.exports.SAFE_SCHEMA = require_default_safe()),
      (t.exports.DEFAULT_SCHEMA = require_default_full()),
      (t.exports.scan = i(`scan`)),
      (t.exports.parse = i(`parse`)),
      (t.exports.compose = i(`compose`)),
      (t.exports.addConstructor = i(`addConstructor`)));
  }),
  require_js_yaml = __commonJSMin((e, t) => {
    t.exports = require_js_yaml$1();
  }),
  require_engines = __commonJSMin((exports, module) => {
...
return ` +
  ...
  require_utils = __commonJSMin((e) => {
    ...
    ((e.define = function (e, t, n) {
      ...
      (e.toString = function (n) {
        if (e.isBuffer(n)) return t(String(n));
        if (typeof n != `string`) throw TypeError(`expected input to be a string or buffer`);
        return t(n);
      }),
      (e.arrayify = function (e) {
        return e ? (Array.isArray(e) ? e : [e]) : [];
      }),
      (e.startsWith = function (e, t, n) {
        return (typeof n != `number` && (n = t.length), e.slice(0, n) === t);
      }));
  }),
  require_defaults = __commonJSMin((e, t) => {
    let n = require_engines(),
      r = require_utils();
    t.exports = function (e) {
      let t = Object.assign({}, e);
      return (
        (t.delimiters = r.arrayify(t.delims || t.delimiters || `---`)),
        t.delimiters.length === 1 && t.delimiters.push(t.delimiters[0]),
        (t.language = (t.language || t.lang || `yaml`).toLowerCase()),
        (t.engines = Object.assign({}, n, t.parsers, t.engines)),
        t
      );
    };
  }),
  require_engine = __commonJSMin((e, t) => {
    t.exports = function (e, t) {
      let r = t.engines[e] || t.engines[n(e)];
      if (r === void 0) throw Error(`gray-matter engine "` + e + `" is not registered`);
  ...
  require_stringify = __commonJSMin((e, t) => {
    let n = require_kind_of(),
      r = require_engine(),
      i = require_defaults();
    t.exports = function (e, t, o) {
      ...
      let l = e.language || c.language,
        u = r(l, c);
      if (typeof u.stringify != `function`)
        throw TypeError(`expected "` + l + `.stringify" to be a function`);
      t = Object.assign({}, e.data, t);
      let d = c.delimiters[0],
        f = c.delimiters[1],
        p = u.stringify(t, o).trim(),
        m = ``;
      return (
        p !== `{}` && (m = a(d) + a(p) + a(f)),
        typeof e.excerpt == `string` &&
          e.excerpt !== `` &&
          s.indexOf(e.excerpt.trim()) === -1 &&
          (m += a(e.excerpt) + a(f)),
        m + a(s)
      );
    };
...
`;
  ...
  require_excerpt = __commonJSMin((e, t) => {
    let n = require_defaults();
    t.exports = function (e, t) {
      let r = n(t);
      if (((e.data ??= {}), typeof r.excerpt == `function`)) return r.excerpt(e, r);
      let i = e.data.excerpt_separator || r.excerpt_separator;
      if (i == null && (r.excerpt === !1 || r.excerpt == null)) return e;
      let a = typeof r.excerpt == `string` ? r.excerpt : i || r.delimiters[0],
        o = e.content.indexOf(a);
      return (o !== -1 && (e.excerpt = e.content.slice(0, o)), e);
    };
  }),
  require_to_file = __commonJSMin((e, t) => {
    let n = require_kind_of(),
      r = require_stringify(),
      i = require_utils();
    t.exports = function (e) {
      return (
        n(e) !== `object` && (e = { content: e }),
        n(e.data) !== `object` && (e.data = {}),
        ...
        i.define(e, `stringify`, function (t, n) {
          return (n && n.language && (e.language = n.language), r(e, t, n));
        }),
  ...
  require_parse = __commonJSMin((e, t) => {
    let n = require_engine(),
      r = require_defaults();
    t.exports = function (e, t, i) {
      let a = r(i),
        o = n(e, a);
      if (typeof o.parse != `function`)
        throw TypeError(`expected "` + e + `.parse" to be a function`);
      return o.parse(t, a);
    };
  }),
  require_gray_matter = __commonJSMin((e, t) => {
    let n = __require(`fs`),
      r = require_section_matter(),
      i = require_defaults(),
      a = require_stringify(),
      o = require_excerpt(),
      s = require_engines(),
...
` + n.delimiters[1],
      ...
      let f = a.length;
      if (!u.startsWith(c, a, f)) return (o(e, n), e);
      if (c.charAt(f) === a.slice(-1)) return e;
      c = c.slice(f);
      let p = c.length,
        m = d.language(c, n);
      m.name && ((e.language = m.name), (c = c.slice(m.raw.length)));
      let h = c.indexOf(s);
      return (
        h === -1 && (h = p),
        (e.matter = c.slice(0, h)),
        e.matter.replace(/^\s*#[^\n]+/gm, ``).trim() === ``
          ? ((e.isEmpty = !0), (e.empty = e.content), (e.data = {}))
          : (e.data = l(e.language, e.matter, n)),
        h === p
          ? (e.content = ``)
          : ((e.content = c.slice(h + s.length)),
            e.content[0] === `\r` && (e.content = e.content.slice(1)),
            e.content[0] ===
              `
` && (e.content = e.content.slice(1))),
        o(e, n),
        (n.sections === !0 || typeof n.section == `function`) && r(e, n.section),
        e
      );
    }
    ((d.engines = s),
      (d.stringify = function (e, t, n) {
        return (typeof e == `string` && (e = d(e, n)), a(e, t, n));
      }),
      (d.read = function (e, t) {
        let r = d(n.readFileSync(e, `utf8`), t);
        return ((r.path = e), r);
      }),
      (d.test = function (e, t) {
        return u.startsWith(e, i(t).delimiters[0]);
      }),
      (d.language = function (e, t) {
        let n = i(t).delimiters[0];
        d.test(e) && (e = e.slice(n.length));
        let r = e.slice(0, e.search(/\r?\n/));
        return { raw: r, name: r ? r.trim() : `` };
      }),
      (d.cache = {}),
