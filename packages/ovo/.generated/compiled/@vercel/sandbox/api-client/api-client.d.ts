...
declare class APIClient extends BaseClient {
  ...
  getFileWriter(params: { sessionId: string; extractDir: string; signal?: AbortSignal }): {
  ...
  >;
  getLogs(params: { sessionId: string; cmdId: string; signal?: AbortSignal }): AsyncGenerator<
    LogOutputLine,
    void,
    void
  > &
  ...
  >;
  deleteSandbox(params: { name: string; projectId: string; signal?: AbortSignal }): Promise<
    Parsed<{
      sandbox: {
        name: string;
        persistent: boolean;
