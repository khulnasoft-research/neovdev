...
declare class Sandbox implements ExecutionContext {
   ...
   */
  static fork(
    params: WithPrivate<ForkSandboxParams | (ForkSandboxParams & Credentials)> & WithFetchOptions,
  ): Promise<Sandbox & AsyncDisposable>;
  /**
   ...
   */
  static get(
    params: WithPrivate<GetSandboxParams | (GetSandboxParams & Credentials)> & WithFetchOptions,
  ): Promise<Sandbox>;
  /**
   ...
   */
  static getOrCreate(
    params?: WithPrivate<GetOrCreateSandboxParams | (GetOrCreateSandboxParams & Credentials)> &
      WithFetchOptions,
  ): Promise<Sandbox>;
  /**
   ...
   */
  openInteractive(opts?: { signal?: AbortSignal }): Promise<{
    url: string;
    token: string;
  }>;
  /**
   ...
   */
  stop(opts?: { signal?: AbortSignal }): Promise<
    SandboxSnapshot & {
   ...
   * @internal
   */
  getDefaultUser(opts?: { signal?: AbortSignal }): Promise<{
    username: string;
    group: string;
  }>;
   ...
   */
  snapshot(opts?: { expiration?: number; signal?: AbortSignal }): Promise<Snapshot>;
  /**
