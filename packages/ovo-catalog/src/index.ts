/**
 * Shared identity for ovo integrations. This package is the single source of
 ...
 * IntegrationEntry.slug}: the scaffolder (ovo) overlays the
 ...
 * directly from source by both NodeNext tooling (`tsc` in ovo,
...
/** Which ovo surfaces an integration is available on today. */
export interface IntegrationSurfaces {
  /** The ovo CLI can scaffold this integration without further work. */
...
/**
 * The canonical set of ovo integrations. Order is display order. Each entry
...
export const INTEGRATIONS: readonly IntegrationEntry[] = [
  ...
  },
  {
    ...
    name: "agent-browser",
    kind: "extension",
    tagline: "Add browser automation tools backed by agent-browser to an ovo agent.",
    surfaces: { scaffoldable: false, gallery: true },
  },
  {
    slug: "kernel",
